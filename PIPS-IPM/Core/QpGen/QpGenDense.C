...
QpGenDense::QpGenDense(int nx_, int my_, int mz_, int /* nnzQ */, int /* nnzA */, int /* nnzC */) : QpGen(nx_, my_, mz_) {
   la = DenseLinearAlgebraPackage::soleInstance();
}
...
QuadraticProblem *
QpGenDense::makeData(double c[], double Q[], double xlow[], char ixlow[], double xupp[], char ixupp[], double A[], double bA[], double C[],
      double clow[], char iclow[], double cupp[], char icupp[]) {
   ...
   return new QuadraticProblem(la, vc, mQ, vxlow, vixlow, vxupp, vixupp, mA, vbA, mC, vclow, viclow, vcupp, vicupp);
}
...
void QpGenDense::joinRHS(OoqpVector &rhs_in, OoqpVector &rhs1_in, OoqpVector &rhs2_in, OoqpVector &rhs3_in) {
...
void QpGenDense::separateVars(OoqpVector &x_in, OoqpVector &y_in, OoqpVector &z_in, OoqpVector &vars_in) {
...
void QpGenDense::makeRandomData(QuadraticProblem *&data, QpGenVars *&soln) {
   data = new QuadraticProblem(la, nx, my, mz, nx * nx, nx * my, nx * mz);
