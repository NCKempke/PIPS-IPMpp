...
#define NUMPRIMES      18
static int prime[NUMPRIMES] = {29, 229, 883, 1669, 2791, 4801, 8629, 15289, 32749, 65521, 131071, 262139, 524287, 1048573, 2097143, 4194301, 8388593,
                               16777213};
...
extern "C" char* StrDup(char* s1, const char*) {
   int ls1 = strlen(s1) + 1;
