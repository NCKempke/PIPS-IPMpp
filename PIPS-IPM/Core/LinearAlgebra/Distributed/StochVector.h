...
public:
   ...
   T find_blocking(const OoqpVectorBase<T> & wstep_vec,
   ...
   void find_blocking_pd(const OoqpVectorBase<T>& wstep_vec,
      const OoqpVectorBase<T>& u_vec,
      const OoqpVectorBase<T>& ustep_vec,
   ...
   virtual void appendHierarchicalToThis( SimpleVector<T>* new_vec, SimpleVector<T>* new_vecl,
...
public:
   ...
   T find_blocking(const OoqpVectorBase<T> &, const OoqpVectorBase<T>&, const OoqpVectorBase<T>&, T maxStep, T*,
      T*, T*, T*, int&) const override {return maxStep; };
   void find_blocking_pd(const OoqpVectorBase<T>&, const OoqpVectorBase<T>&, const OoqpVectorBase<T>&, T&, T&,
      T&, T&, T&, T&, T&, T&, T&, T&, bool&, bool&) const override{};
