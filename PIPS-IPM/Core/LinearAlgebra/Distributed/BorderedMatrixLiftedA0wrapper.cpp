...
void BorderedMatrixLiftedA0wrapper::transMult(double beta, Vector<double>& y_in, double alpha, const Vector<double>& x_in) const {
   set_column_vector_first_for_child(x_in);
   BorderedMatrix::transMult(beta, y_in, alpha, x_in);
