...
extern "C" {
void FNAME(mc30ad)(int* n, int* ne, const double a[], const int irn[], const int icn[], double s[], double w[], int* lp, int* ifail);
}
...
public:
   ...
   void scaleMatrixCSRFormat(int, int, double*, const int*, const int*, bool) override { assert(false && "TODO : implement"); };
