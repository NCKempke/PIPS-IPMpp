...
extern "C" void ma86_analyse_d(const int n, const int ptr[], const int row[], int order[], void** keep, const struct ma86_control_d* control,
      struct ma86_info_d* info);

extern "C" void ma86_factor_d(const int n, const int ptr[], const int row[], const ma86pkgtype_d_ val[], const int order[], void** keep,
      const struct ma86_control_d* control, struct ma86_info_d* info, const ma86realtype_d_ scale[]);

/* To factorize the matrix AND solve AX = B */
extern "C" void ma86_factor_solve_d(const int n, const int ptr[], const int row[], const ma86pkgtype_d_ val[], const int order[], void** keep,
      const struct ma86_control_d* control, struct ma86_info_d* info, const int nrhs, const int ldx, ma86pkgtype_d_ x[],
      const ma86realtype_d_ scale[]);

/* To solve AX = B using the computed factors */
extern "C" void
ma86_solve_d(const int job, const int nrhs, const int ldx, ma86pkgtype_d_* x, const int order[], void** keep, const struct ma86_control_d* control,
      struct ma86_info_d* info, const ma86realtype_d_ scale[]);
...
/* Perform ordering */
extern "C" void
mc68_order(const int ord, const int n, const int ptr[], const int row[], int perm[], const struct mc68_control* control, struct mc68_info* info);
