...
public:
   ...
   virtual void pushAwayFromZero(double /*tol*/, double /*amount*/, const OoqpVectorBase<T>* /*select */ ) { assert(0 && "Not implemented here"); };
   ...
   virtual void writeMPSformatBoundsWithVar(std::ostream&, const std::string, const OoqpVectorBase<T>*, bool) const {
    ...
    */
   virtual T
   shiftedDotProductWith(T alpha, const OoqpVectorBase<T>& mystep, const OoqpVectorBase<T>& yvec, T beta, const OoqpVectorBase<T>& ystep) const = 0;
   ...
   virtual void writefSomeToStream(std::ostream& out, const char format[], const OoqpVectorBase<T>& select) const = 0;
   /** this += alpha * x / z
    ...
    *         OoqpVector.
    */
   virtual void axdzpy(T alpha, const OoqpVectorBase<T>& x, const OoqpVectorBase<T>& z, const OoqpVectorBase<T>& select) = 0;
   ...
   virtual void getSumCountIfSmall(double, double&, int&, const OoqpVectorBase<T>*) const { assert(0 && "not implemented here"); };

   virtual void
   pushSmallComplementarityPairs(OoqpVectorBase<T>& /*other_vec*/, const OoqpVectorBase<T>& /*select_in*/, double /*tol_this*/, double /*tol_other*/,
         double /*tol_pairs*/) { assert(0 && "not implemented here"); };

   virtual OoqpVectorBase<T>* clone() const {
      assert(0 && "not implemented here");
      return nullptr;
   };
   virtual OoqpVectorBase<T>* cloneFull() const {
      assert(0 && "not implemented here");
      return nullptr;
   };
};
