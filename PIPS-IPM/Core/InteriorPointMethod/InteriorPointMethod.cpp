...
void PrimalInteriorPointMethod::take_step(Variables& iterate, Variables& step) {
...
void PrimalDualInteriorPointMethod::take_step(Variables& iterate, Variables& step) {
