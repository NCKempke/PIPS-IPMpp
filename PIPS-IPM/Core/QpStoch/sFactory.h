...
public:
  ...
  virtual sLinsysRoot* newLinsysRoot(DistributedQP* prob, OoqpVector* dd, OoqpVector* dq,
        OoqpVector* nomegaInv, OoqpVector* regP, OoqpVector* regDy, OoqpVector* regDz, OoqpVector* rhs ) = 0;
  virtual sLinsysLeaf* newLinsysLeaf(DistributedQP* prob, OoqpVector* dd, OoqpVector* dq,
