...
protected:
   ...
   void addBlTKiInvBrToRes(DoubleMatrix& result, BorderLinsys& Bl, BorderLinsys& Br, std::vector<BorderMod>& Br_mod_border, bool sym_res,
         bool sparse_res) override;
   void addBlTKiInvBrToResBlockwise(DoubleMatrix& result, BorderLinsys& Bl, BorderLinsys& Br, std::vector<BorderMod>& Br_mod_border, bool sym_res,
         bool sparse_res, DenseGenMatrix& buffer_b0, int begin_cols, int end_cols);
...
private:
   ...
   void compute_CtDC_and_add_to_Schur_complement(SymMatrix*& CtDC_loc, const Vector<double>& diagonal);
