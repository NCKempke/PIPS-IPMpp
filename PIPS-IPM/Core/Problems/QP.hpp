...
public:
   ...
   virtual void evaluate_objective_gradient(const Variables& variables, Vector<double>& gradient) const override;

   virtual double evaluate_objective(const Variables& variables) const override;
