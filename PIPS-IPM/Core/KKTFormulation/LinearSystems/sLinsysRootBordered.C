...
void sLinsysRootBordered::finalizeKKT() {
   ...
   const auto& F0 = *dynamic_cast<const BorderedMatrix&>(*data->equality_jacobian).bottom_left_block;
   const auto& G0 = *dynamic_cast<const BorderedMatrix&>(*data->inequality_jacobian).bottom_left_block;
...
void sLinsysRootBordered::computeSchurCompRightHandSide(const DistributedVector<double>& rhs_inner, SimpleVector<double>& b0) {
   ...
   BorderLinsys border(*dynamic_cast<const BorderedSymmetricMatrix&>(*data->Q).border_vertical, *dynamic_cast<const BorderedMatrix&>(*data->equality_jacobian).border_left,
...
void sLinsysRootBordered::assembleLocalKKT() {
   ...
   BorderLinsys B(*dynamic_cast<const BorderedSymmetricMatrix&>(*data->Q).border_vertical, *dynamic_cast<const BorderedMatrix&>(*data->equality_jacobian).border_left,
         *dynamic_cast<const BorderedMatrix&>(*data->inequality_jacobian).border_left, 0, *dynamic_cast<const BorderedMatrix&>(*data->equality_jacobian).border_bottom,
         *dynamic_cast<const BorderedMatrix&>(*data->inequality_jacobian).border_bottom);
