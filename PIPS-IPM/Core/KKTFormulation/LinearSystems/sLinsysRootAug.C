...
sLinsysRootAug::sLinsysRootAug(DistributedFactory* factory_, DistributedProblem* prob_) : DistributedRootLinearSystem(
   factory_, prob_) {
...
sLinsysRootAug::sLinsysRootAug(DistributedFactory* factory_, DistributedProblem* prob_, std::shared_ptr<Vector<double>> dd_,
