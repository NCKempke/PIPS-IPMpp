...
public:
   ...
   DistributedLinearSystem(const DistributedFactory& factory, DistributedQP* prob, bool is_hierarchy_root = false);

   DistributedLinearSystem(const DistributedFactory& factory, DistributedQP* prob, std::shared_ptr<Vector<double>> dd, std::shared_ptr<Vector<double>> dq, std::shared_ptr<Vector<double>> nomegaInv,
