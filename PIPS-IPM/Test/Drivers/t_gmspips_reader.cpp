...
TEST_P(GmspipsReaderTest, TestReadGamsSmallProblems )
{
   ...
   ASSERT_TRUE( tree );
   sFactoryAug factory( tree.get(), MPI_COMM_WORLD );
};
...
INSTANTIATE_TEST_CASE_P(
      TestReadGamsSmallProblems,
      GmspipsReaderTest,
      ::testing::Values(
            std::make_tuple( examples_path + "examples_boundTightening/run_exampleAC_boundStrength/exampleAC_boundStrength", 3 ),
//            std::make_tuple( examples_path + "examples_dualfixing/run_dual_fixing_A2/exampleAC_boundStrength", 3 ),
            ...
            std::make_tuple( examples_path + "examples_nearlyParallelRows/run_nearlyParallelEqualityAndInequalityRows_B0A2/nearlyParallelEqualityAndInequalityRows_B0A2", 4 ),
//            std::make_tuple( examples_path + "examples_nearlyParallelRows/run_nearlyParallelEqualityInequalityRowsMixed/nearlyParallelEqualityInequalityRowsMixed", 8 ),
            std::make_tuple( examples_path + "examples_nearlyParallelRows/run_nearlyParallelEqualityRowsBothSingletons_B0A2/nearlyParallelEqualityRowsBothSingletons_B0A2", 4 ),
            std::make_tuple( examples_path + "examples_nearlyParallelRows/run_nearlyParallelEqualityRowsOneRowNoSingleton_B0A2/nearlyParallelEqualityRowsOneRowNoSingleton_B0A2", 4 ),
            ...
            std::make_tuple( examples_path + "examples_parallelRows/run_parallelEqualityAndInequalityRow_B0A2/parallelEqualityAndInequalityRow_B0A2", 4 ),
            ...
            std::make_tuple( examples_path + "examples_singletonEqualityColumn/run_singletonEqualityColumn_multiple_noLink/singletonEqualityColumn_multiple_noLink", 4 ),
            std::make_tuple( examples_path + "examples_singletonEqualityColumn/run_singletonEqualityColumn_multiple_resulting/singletonEqualityColumn_multiple_resulting", 4 ),
            std::make_tuple( examples_path + "examples_singletonEqualityColumn/run_singletonEqualityColumn_multiple_resulting_noLink/singletonEqualityColumn_multiple_resulting_noLink", 4 ),
            ...
            std::make_tuple( examples_path + "examples_singletonInequalityColumn/run_singletonInequalityColumn_B0B2A1/singletonInequalityColumn_B0B2A1", 4 ),
            std::make_tuple( examples_path + "examples_singletonInequalityColumn/run_singletonInequalityColumn_B0Bl0/singletonInequalityColumn_B0Bl0", 4 ),
            std::make_tuple( examples_path + "examples_singletonInequalityColumn/run_singletonInequalityColumn_B0Bl2/singletonInequalityColumn_B0Bl2", 4 ),
            ...
            std::make_tuple( examples_path + "examples_singletonInequalityColumn/run_singletonInequalityColumn_multipleLinkingFixationsAndSingletonCols/singletonInequalityColumn_multipleLinkingFixationsAndSingletonCols", 4 ),
            std::make_tuple( examples_path + "examples_singletonInequalityColumn/run_singletonInequalityColumn_multiple_resulting/singletonInequalityColumn_multiple_resulting", 4 ),

            std::make_tuple( examples_path + "examples_singletonRow/run_exampleAC_singletonRow2/exampleAC_singletonRow2", 3 ),
            std::make_tuple( examples_path + "examples_singletonRow/run_exampleAC_singletonRow3_singletonLinkingRow/exampleAC_singletonRow3_singletonLinkingRow", 3 ),
            std::make_tuple( examples_path + "examples_singletonRow/run_exampleAC_singletonRow/exampleAC_singletonRow", 3 ),
