...
int main(int argc, char** argv) {
   ...
   if (stepDiffLp) {
      ...
      PIPSIpmInterface<DistributedFactory, GondzioStochLpSolver> pipsIpm(root, MPI_COMM_WORLD, scaler_type,
      ...
      PIPSIpmInterface<DistributedFactory, GondzioStochSolver> pipsIpm(root, MPI_COMM_WORLD, scaler_type,
            presolve ? PRESOLVER_STOCH : PRESOLVER_NONE);
