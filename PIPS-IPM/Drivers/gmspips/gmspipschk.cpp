...
int readOneBlock(const int numBlocks, const int actBlock, const int debug, const int offset, const int fType, const char* pDirStem,
      const char* pGAMSSysDir, GMSPIPSBlockData_t* block) {
