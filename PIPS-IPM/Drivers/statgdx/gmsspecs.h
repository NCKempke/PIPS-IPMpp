...
cnstdef {GMSSPECS_maxevalthreads = 64};
...
cnstdef {GMSSPECS_equ_userinfo_base = 53};
...
cnstdef {GMSSPECS_numsolprint = 5};
cnstdef {GMSSPECS_numhandlestat = 3};
cnstdef {GMSSPECS_numsolvelink = 7};
cnstdef {GMSSPECS_numsolveopt = 2};
