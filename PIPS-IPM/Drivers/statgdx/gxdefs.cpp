...
_arr_0GXDEFS GXDEFS_gdxdatatypstr = {{3, 'S', 'e', 't'},
                                     {3, 'P', 'a', 'r'},
                                     {3, 'V', 'a', 'r'},
                                     {3, 'E', 'q', 'u'},
                                     {5, 'A', 'l', 'i', 'a', 's'}};
_arr_1GXDEFS GXDEFS_gdxdatatypstrl = {{3, 'S', 'e', 't'},
                                      {9, 'P', 'a', 'r', 'a', 'm', 'e', 't', 'e', 'r'},
                                      {8, 'V', 'a', 'r', 'i', 'a', 'b', 'l', 'e'},
                                      {8, 'E', 'q', 'u', 'a', 't', 'i', 'o', 'n'},
                                      {5, 'A', 'l', 'i', 'a', 's'}};
_arr_2GXDEFS GXDEFS_datatypsize = {1, 1, 5, 5, 0};
_arr_3GXDEFS GXDEFS_gdxspecialvaluesstr = {{4, 'U', 'n', 'd', 'f'},
                                           {2, 'N', 'A'},
                                           {4, '+', 'I', 'n', 'f'},
                                           {4, '-', 'I', 'n', 'f'},
                                           {3, 'E', 'p', 's'},
...
Function(SYSTEM_boolean) GXDEFS_canbequoted(const SYSTEM_ansichar* s) {
...
Function(SYSTEM_boolean) GXDEFS_gooduelstring(const SYSTEM_ansichar* s) {
   SYSTEM_boolean result;
