...
void* const P3THREADS_ep3thread_VT[] = {(void*) &SYSTEM_tobject_DOT_destroy};

/* Class descriptor for 'ep3thread' */
const SYSTEM_classdescriptor_t P3THREADS_ep3thread_CD = {_P3str1("\011ep3thread"), &SYSTEM_exception_CD, NULL, 0, sizeof(P3THREADS_ep3thread_OD),
                                                         P3THREADS_ep3thread_VT, NULL};


void* const P3THREADS_ep3mutex_VT[] = {(void*) &SYSTEM_tobject_DOT_destroy};

/* Class descriptor for 'ep3mutex' */
const SYSTEM_classdescriptor_t P3THREADS_ep3mutex_CD = {_P3str1("\010ep3mutex"), &SYSTEM_exception_CD, NULL, 0, sizeof(P3THREADS_ep3mutex_OD),
                                                        P3THREADS_ep3mutex_VT, NULL};


void* const P3THREADS_ep3condvar_VT[] = {(void*) &SYSTEM_tobject_DOT_destroy};

/* Class descriptor for 'ep3condvar' */
const SYSTEM_classdescriptor_t P3THREADS_ep3condvar_CD = {_P3str1("\012ep3condvar"), &SYSTEM_exception_CD, NULL, 0, sizeof(P3THREADS_ep3condvar_OD),
                                                          P3THREADS_ep3condvar_VT, NULL};


void* const P3THREADS_ep3sharedmutex_VT[] = {(void*) &SYSTEM_tobject_DOT_destroy};

/* Class descriptor for 'ep3sharedmutex' */
const SYSTEM_classdescriptor_t P3THREADS_ep3sharedmutex_CD = {_P3str1("\016ep3sharedmutex"), &SYSTEM_exception_CD, NULL, 0,
                                                              sizeof(P3THREADS_ep3sharedmutex_OD), P3THREADS_ep3sharedmutex_VT, NULL};


void* const P3THREADS_tp3thread_VT[] = {(void*) &P3THREADS_tp3thread_DOT_destroy, (void*) &_P3_abstract_call1};

/* Class descriptor for 'tp3thread' */
const SYSTEM_classdescriptor_t P3THREADS_tp3thread_CD = {_P3str1("\011tp3thread"), &SYSTEM_tobject_CD, NULL, 0, sizeof(P3THREADS_tp3thread_OD),
                                                         P3THREADS_tp3thread_VT, NULL};


void* const P3THREADS_tp3mutex_VT[] = {(void*) &P3THREADS_tp3mutex_DOT_destroy};

/* Class descriptor for 'tp3mutex' */
const SYSTEM_classdescriptor_t P3THREADS_tp3mutex_CD = {_P3str1("\010tp3mutex"), &SYSTEM_tobject_CD, NULL, 0, sizeof(P3THREADS_tp3mutex_OD),
                                                        P3THREADS_tp3mutex_VT, NULL};


void* const P3THREADS_tp3condvar_VT[] = {(void*) &P3THREADS_tp3condvar_DOT_destroy};

/* Class descriptor for 'tp3condvar' */
const SYSTEM_classdescriptor_t P3THREADS_tp3condvar_CD = {_P3str1("\012tp3condvar"), &SYSTEM_tobject_CD, NULL, 0, sizeof(P3THREADS_tp3condvar_OD),
                                                          P3THREADS_tp3condvar_VT, NULL};


void* const P3THREADS_tp3sharedmutex_VT[] = {(void*) &P3THREADS_tp3sharedmutex_DOT_destroy};

/* Class descriptor for 'tp3sharedmutex' */
const SYSTEM_classdescriptor_t P3THREADS_tp3sharedmutex_CD = {_P3str1("\016tp3sharedmutex"), &SYSTEM_tobject_CD, NULL, 0,
...
static pthread_t voidPtr2threadHandle(void* v) {
   pthreadPtr_t r;
...
static void* threadHandle2voidPtr(pthread_t p) {
   pthreadPtr_t r;
...
Procedure P3THREADS_gettimespec(SYSTEM_P3_tdatetime dt, SYSTEM_int64* tv_sec, SYSTEM_int64* tv_nsec) {
   *tv_sec = -1;
   *tv_nsec = -1;
...
static Function(SYSTEM_cardinal)  STDCALL P3THREADS_threadwrapper(SYSTEM_pointer arg) {
...
static void* threadWrapper(SYSTEM_pointer arg) {
   P3THREADS_pp3threadrec p;
   P3THREADS_tp3threadfunc f;
   SYSTEM_pointer ptr;
...
static Function(SYSTEM_integer) P3THREADS_threadproc(P3THREADS_tp3thread thread) {
   SYSTEM_integer result;
...
# endif
   ...
   if (!thread->P3THREADS_tp3thread_DOT_fterminated)
      VirtMethodCall(thread, P3THREADS_tp3thread_DOT_execute_T, 1, (thread));
...
Function(SYSTEM_int64) P3THREADS_tp3thread_DOT_getthreadid(P3THREADS_tp3thread self) {
   SYSTEM_int64 result;
...
Function(SYSTEM_boolean) P3THREADS_tp3thread_DOT_semisnull(P3THREADS_tp3thread self) {
...
Function(SYSTEM_boolean) P3THREADS_tp3thread_DOT_issuspended(P3THREADS_tp3thread self) {
   SYSTEM_boolean result;
...
Constructor(P3THREADS_tp3thread) P3THREADS_tp3thread_DOT_create(P3THREADS_tp3thread self, SYSTEM_boolean createsuspended) {
   P3THREADS_pp3threadrec p;
   SYSTEM_shortstring msg, tmp;
   SYSTEM_integer nbytes;

   ValueCast(P3THREADS_tp3thread, SYSTEM_tobject_DOT_create(ValueCast(SYSTEM_tobject, self)));
   if (!createsuspended)
      _P3_RAISE(ValueCast(P3THREADS_ep3thread, SYSTEM_exception_DOT_create(ValueCast(SYSTEM_exception, _P3alloc_object(&P3THREADS_ep3thread_CD)),
            _P3str1("\063Thread creation error: createSuspended must be true"))));
   nbytes = 0;
   ...
   if (nbytes > 64) {
      {
         ...
         _P3strcat(msg, 255, _P3strcat(_t5, 255, _P3strcat(_t3, 255,
               _P3strcat(_t2, 255, _P3str1("\064internal Tp3Thread error: sizeof(semaphore/mutex) = "), SYSUTILS_P3_inttostr(_t1, 255, nbytes)),
               _P3str1("\023 but only reserved ")), SYSUTILS_P3_inttostr(_t4, 255, P3THREADS_p3_semsize)), _P3str1("\006 bytes"));
      }
      _P3_RAISE(
            ValueCast(P3THREADS_ep3thread, SYSTEM_exception_DOT_create(ValueCast(SYSTEM_exception, _P3alloc_object(&P3THREADS_ep3thread_CD)), msg)));
   }
   nbytes = 0;
   ...
   if (nbytes > ValueCast(SYSTEM_int32, sizeof(SYSTEM_pointer))) {
      {
         ...
         _P3strcat(msg, 255, _P3strcat(_t3, 255, _P3strcat(_t2, 255, _P3str1("\077internal Tp3Thread error: sizeof(pthread_t) > sizeof(pointer): "),
               SYSUTILS_P3_inttostr(_t1, 255, nbytes)), _P3str1("\003 > ")), SYSUTILS_P3_inttostr(_t4, 255, sizeof(SYSTEM_pointer)));
      }
      _P3_RAISE(
            ValueCast(P3THREADS_ep3thread, SYSTEM_exception_DOT_create(ValueCast(SYSTEM_exception, _P3alloc_object(&P3THREADS_ep3thread_CD)), msg)));
   }
...
Destructor(P3THREADS_tp3thread) P3THREADS_tp3thread_DOT_destroy(P3THREADS_tp3thread self) {
   if (self->P3THREADS_tp3thread_DOT_fthreadid._u._c2.h64 != 0 && !self->P3THREADS_tp3thread_DOT_ffinished) {
...
Procedure P3THREADS_tp3thread_DOT_resume(P3THREADS_tp3thread self) {
...
Procedure P3THREADS_tp3thread_DOT_terminate(P3THREADS_tp3thread self) {
   self->P3THREADS_tp3thread_DOT_fterminated = SYSTEM_true;
}  /* terminate */

Function(SYSTEM_longword) P3THREADS_tp3thread_DOT_waitfor(P3THREADS_tp3thread self) {
...
Constructor(P3THREADS_tp3mutex) P3THREADS_tp3mutex_DOT_create(P3THREADS_tp3mutex self) {
   SYSTEM_shortstring msg;
   SYSTEM_integer nbytes;

   ValueCast(P3THREADS_tp3mutex, SYSTEM_tobject_DOT_create(ValueCast(SYSTEM_tobject, self)));
   nbytes = 0;
   ...
   if (nbytes > 64) {
      {
         ...
         _P3strcat(msg, 255, _P3strcat(_t5, 255, _P3strcat(_t3, 255,
               _P3strcat(_t2, 255, _P3str1("\065internal Tp3Mutex error: sizeof(os_specific_mutex) = "), SYSUTILS_P3_inttostr(_t1, 255, nbytes)),
               _P3str1("\023 but only reserved ")), SYSUTILS_P3_inttostr(_t4, 255, P3THREADS_p3_muxsize)), _P3str1("\006 bytes"));
      }
      _P3_RAISE(
            ValueCast(P3THREADS_ep3mutex, SYSTEM_exception_DOT_create(ValueCast(SYSTEM_exception, _P3alloc_object(&P3THREADS_ep3mutex_CD)), msg)));
   }
...
Destructor(P3THREADS_tp3mutex) P3THREADS_tp3mutex_DOT_destroy(P3THREADS_tp3mutex self) {
...
Procedure P3THREADS_tp3mutex_DOT_lock(P3THREADS_tp3mutex self) {
...
Function(SYSTEM_boolean) P3THREADS_tp3mutex_DOT_trylock(P3THREADS_tp3mutex self) {
   SYSTEM_boolean result;
...
Procedure P3THREADS_tp3mutex_DOT_unlock(P3THREADS_tp3mutex self) {
   SYSTEM_shortstring msg;
...
Constructor(P3THREADS_tp3condvar) P3THREADS_tp3condvar_DOT_create(P3THREADS_tp3condvar self) {
   SYSTEM_shortstring msg;
   SYSTEM_integer nbytes;

   ValueCast(P3THREADS_tp3condvar, SYSTEM_tobject_DOT_create(ValueCast(SYSTEM_tobject, self)));
   nbytes = 0;
   ...
   if (nbytes > 64) {
      {
         ...
         _P3strcat(msg, 255, _P3strcat(_t5, 255, _P3strcat(_t3, 255,
               _P3strcat(_t2, 255, _P3str1("\071internal Tp3CondVar error: sizeof(os_specific_condVar) = "), SYSUTILS_P3_inttostr(_t1, 255, nbytes)),
               _P3str1("\023 but only reserved ")), SYSUTILS_P3_inttostr(_t4, 255, P3THREADS_p3_condvarsize)), _P3str1("\006 bytes"));
      }
      _P3_RAISE(ValueCast(P3THREADS_ep3condvar,
            SYSTEM_exception_DOT_create(ValueCast(SYSTEM_exception, _P3alloc_object(&P3THREADS_ep3condvar_CD)), msg)));
   }
...
Destructor(P3THREADS_tp3condvar) P3THREADS_tp3condvar_DOT_destroy(P3THREADS_tp3condvar self) {
...
Procedure P3THREADS_tp3condvar_DOT_notifyone(P3THREADS_tp3condvar self) {
   SYSTEM_shortstring msg;
...
Procedure P3THREADS_tp3condvar_DOT_notifyall(P3THREADS_tp3condvar self) {
   SYSTEM_shortstring msg;
...
Procedure P3THREADS_tp3condvar_DOT_wait(P3THREADS_tp3condvar self, P3THREADS_tp3mutex mx) {
   SYSTEM_shortstring msg;
...
Function(SYSTEM_boolean) P3THREADS_tp3condvar_DOT_timedwaitabs(P3THREADS_tp3condvar self, P3THREADS_tp3mutex mx, P3THREADS_tcvtime abstime) {
   SYSTEM_boolean result;
   SYSTEM_shortstring msg;
...
Constructor(P3THREADS_tp3sharedmutex) P3THREADS_tp3sharedmutex_DOT_create(P3THREADS_tp3sharedmutex self) {
   self->P3THREADS_tp3sharedmutex_DOT_statechange = ValueCast(P3THREADS_tp3mutex,
         P3THREADS_tp3mutex_DOT_create(ValueCast(P3THREADS_tp3mutex, _P3alloc_object(&P3THREADS_tp3mutex_CD))));
   self->P3THREADS_tp3sharedmutex_DOT_shared = ValueCast(P3THREADS_tp3condvar,
         P3THREADS_tp3condvar_DOT_create(ValueCast(P3THREADS_tp3condvar, _P3alloc_object(&P3THREADS_tp3condvar_CD))));
   self->P3THREADS_tp3sharedmutex_DOT_upgrade = ValueCast(P3THREADS_tp3condvar,
         P3THREADS_tp3condvar_DOT_create(ValueCast(P3THREADS_tp3condvar, _P3alloc_object(&P3THREADS_tp3condvar_CD))));
   self->P3THREADS_tp3sharedmutex_DOT_exclusive = ValueCast(P3THREADS_tp3condvar,
         P3THREADS_tp3condvar_DOT_create(ValueCast(P3THREADS_tp3condvar, _P3alloc_object(&P3THREADS_tp3condvar_CD))));
   return self;
}  /* create */

Destructor(P3THREADS_tp3sharedmutex) P3THREADS_tp3sharedmutex_DOT_destroy(P3THREADS_tp3sharedmutex self) {
   SYSTEM_tobject_DOT_free(ValueCast(SYSTEM_tobject, self->P3THREADS_tp3sharedmutex_DOT_statechange));
   SYSTEM_tobject_DOT_free(ValueCast(SYSTEM_tobject, self->P3THREADS_tp3sharedmutex_DOT_shared));
   SYSTEM_tobject_DOT_free(ValueCast(SYSTEM_tobject, self->P3THREADS_tp3sharedmutex_DOT_upgrade));
   SYSTEM_tobject_DOT_free(ValueCast(SYSTEM_tobject, self->P3THREADS_tp3sharedmutex_DOT_exclusive));
   return self;
}  /* destroy */

Procedure P3THREADS_tp3sharedmutex_DOT_releasewaiters(P3THREADS_tp3sharedmutex self) {
   self->P3THREADS_tp3sharedmutex_DOT_fstate.exclusivewaitingblocked = self->P3THREADS_tp3sharedmutex_DOT_fstate.upgradewaitingblocked;
   P3THREADS_tp3condvar_DOT_notifyone(self->P3THREADS_tp3sharedmutex_DOT_exclusive);
   P3THREADS_tp3condvar_DOT_notifyall(self->P3THREADS_tp3sharedmutex_DOT_shared);
}  /* releasewaiters */

Procedure P3THREADS_tp3sharedmutex_DOT_lock(P3THREADS_tp3sharedmutex self) {
   P3THREADS_tp3mutex_DOT_lock(self->P3THREADS_tp3sharedmutex_DOT_statechange);
   while (self->P3THREADS_tp3sharedmutex_DOT_fstate.nshared > 0 || self->P3THREADS_tp3sharedmutex_DOT_fstate.exclusive) {
      self->P3THREADS_tp3sharedmutex_DOT_fstate.exclusivewaitingblocked = SYSTEM_true;
      P3THREADS_tp3condvar_DOT_wait(self->P3THREADS_tp3sharedmutex_DOT_exclusive, self->P3THREADS_tp3sharedmutex_DOT_statechange);
   }
   self->P3THREADS_tp3sharedmutex_DOT_fstate.exclusive = SYSTEM_true;
   P3THREADS_tp3mutex_DOT_unlock(self->P3THREADS_tp3sharedmutex_DOT_statechange);
}  /* lock */

Function(SYSTEM_boolean) P3THREADS_tp3sharedmutex_DOT_trylock(P3THREADS_tp3sharedmutex self) {
   SYSTEM_boolean result;
...
Procedure P3THREADS_tp3sharedmutex_DOT_unlock(P3THREADS_tp3sharedmutex self) {
   P3THREADS_tp3mutex_DOT_lock(self->P3THREADS_tp3sharedmutex_DOT_statechange);
...
Procedure P3THREADS_tp3sharedmutex_DOT_lockshared(P3THREADS_tp3sharedmutex self) {
   P3THREADS_tp3mutex_DOT_lock(self->P3THREADS_tp3sharedmutex_DOT_statechange);
   while (self->P3THREADS_tp3sharedmutex_DOT_fstate.exclusive || self->P3THREADS_tp3sharedmutex_DOT_fstate.exclusivewaitingblocked) {

      P3THREADS_tp3condvar_DOT_wait(self->P3THREADS_tp3sharedmutex_DOT_shared, self->P3THREADS_tp3sharedmutex_DOT_statechange);
   }
   _P3inc0(self->P3THREADS_tp3sharedmutex_DOT_fstate.nshared);
   P3THREADS_tp3mutex_DOT_unlock(self->P3THREADS_tp3sharedmutex_DOT_statechange);
}  /* lockshared */

Function(SYSTEM_boolean) P3THREADS_tp3sharedmutex_DOT_trylockshared(P3THREADS_tp3sharedmutex self) {
   SYSTEM_boolean result;
...
Procedure P3THREADS_tp3sharedmutex_DOT_unlockshared(P3THREADS_tp3sharedmutex self) {
   P3THREADS_tp3mutex_DOT_lock(self->P3THREADS_tp3sharedmutex_DOT_statechange);
   _P3dec0(self->P3THREADS_tp3sharedmutex_DOT_fstate.nshared);
   if (0 == self->P3THREADS_tp3sharedmutex_DOT_fstate.nshared)
      if (self->P3THREADS_tp3sharedmutex_DOT_fstate.upgradewaitingblocked) {
         ...
         SYSTEM_assert(self->P3THREADS_tp3sharedmutex_DOT_fstate.upgradewaitingblocked, _P3str1("\000"));
         self->P3THREADS_tp3sharedmutex_DOT_fstate.upgrade = SYSTEM_false;
         self->P3THREADS_tp3sharedmutex_DOT_fstate.exclusive = SYSTEM_true;
         self->P3THREADS_tp3sharedmutex_DOT_fstate.upgradewaitingblocked = SYSTEM_false;
         P3THREADS_tp3condvar_DOT_notifyone(self->P3THREADS_tp3sharedmutex_DOT_upgrade);
      }
   P3THREADS_tp3sharedmutex_DOT_releasewaiters(self);
   if (0 == self->P3THREADS_tp3sharedmutex_DOT_fstate.nshared) SYSTEM_assert(!self->P3THREADS_tp3sharedmutex_DOT_fstate.exclusivewaitingblocked,
         _P3str1("\000"));
   P3THREADS_tp3mutex_DOT_unlock(self->P3THREADS_tp3sharedmutex_DOT_statechange);
}  /* unlockshared */

Procedure P3THREADS_tp3sharedmutex_DOT_lockupgrade(P3THREADS_tp3sharedmutex self) {
   P3THREADS_tp3mutex_DOT_lock(self->P3THREADS_tp3sharedmutex_DOT_statechange);
   while (self->P3THREADS_tp3sharedmutex_DOT_fstate.exclusive || self->P3THREADS_tp3sharedmutex_DOT_fstate.exclusivewaitingblocked ||
...
Function(SYSTEM_boolean) P3THREADS_tp3sharedmutex_DOT_trylockupgrade(P3THREADS_tp3sharedmutex self) {
   SYSTEM_boolean result;
...
Procedure P3THREADS_tp3sharedmutex_DOT_unlockupgrade(P3THREADS_tp3sharedmutex self) {
   P3THREADS_tp3mutex_DOT_lock(self->P3THREADS_tp3sharedmutex_DOT_statechange);
   self->P3THREADS_tp3sharedmutex_DOT_fstate.upgrade = SYSTEM_false;
   _P3dec0(self->P3THREADS_tp3sharedmutex_DOT_fstate.nshared);
   if (0 == self->P3THREADS_tp3sharedmutex_DOT_fstate.nshared)
...
Procedure P3THREADS_tp3sharedmutex_DOT_unlockupgrade_and_lock(P3THREADS_tp3sharedmutex self) {
   P3THREADS_tp3mutex_DOT_lock(self->P3THREADS_tp3sharedmutex_DOT_statechange);
   _P3dec0(self->P3THREADS_tp3sharedmutex_DOT_fstate.nshared);
   SYSTEM_assert(!self->P3THREADS_tp3sharedmutex_DOT_fstate.exclusive, _P3str1("\000"));
   SYSTEM_assert(self->P3THREADS_tp3sharedmutex_DOT_fstate.upgrade, _P3str1("\000"));
   while (self->P3THREADS_tp3sharedmutex_DOT_fstate.nshared > 0) {
      self->P3THREADS_tp3sharedmutex_DOT_fstate.upgradewaitingblocked = SYSTEM_true;
      self->P3THREADS_tp3sharedmutex_DOT_fstate.exclusivewaitingblocked = SYSTEM_true;
      SYSTEM_assert(self->P3THREADS_tp3sharedmutex_DOT_fstate.upgrade, _P3str1("\000"));
      P3THREADS_tp3condvar_DOT_wait(self->P3THREADS_tp3sharedmutex_DOT_upgrade, self->P3THREADS_tp3sharedmutex_DOT_statechange);
      SYSTEM_assert(!self->P3THREADS_tp3sharedmutex_DOT_fstate.upgrade, _P3str1("\000"));
      SYSTEM_assert(self->P3THREADS_tp3sharedmutex_DOT_fstate.exclusive, _P3str1("\000"));
   }
   self->P3THREADS_tp3sharedmutex_DOT_fstate.upgrade = SYSTEM_false;
   self->P3THREADS_tp3sharedmutex_DOT_fstate.exclusive = SYSTEM_true;
   SYSTEM_assert(self->P3THREADS_tp3sharedmutex_DOT_fstate.upgradewaitingblocked == SYSTEM_false, _P3str1("\000"));
   P3THREADS_tp3mutex_DOT_unlock(self->P3THREADS_tp3sharedmutex_DOT_statechange);
}  /* unlockupgrade_and_lock */

Procedure P3THREADS_tp3sharedmutex_DOT_unlock_and_lockupgrade(P3THREADS_tp3sharedmutex self) {
   P3THREADS_tp3mutex_DOT_lock(self->P3THREADS_tp3sharedmutex_DOT_statechange);
   self->P3THREADS_tp3sharedmutex_DOT_fstate.exclusive = SYSTEM_false;
   self->P3THREADS_tp3sharedmutex_DOT_fstate.upgrade = SYSTEM_true;
   _P3inc0(self->P3THREADS_tp3sharedmutex_DOT_fstate.nshared);
...
Procedure P3THREADS_tp3sharedmutex_DOT_unlock_and_lockshared(P3THREADS_tp3sharedmutex self) {
   P3THREADS_tp3mutex_DOT_lock(self->P3THREADS_tp3sharedmutex_DOT_statechange);
   self->P3THREADS_tp3sharedmutex_DOT_fstate.exclusive = SYSTEM_false;
   _P3inc0(self->P3THREADS_tp3sharedmutex_DOT_fstate.nshared);
   P3THREADS_tp3sharedmutex_DOT_releasewaiters(self);
...
Procedure P3THREADS_tp3sharedmutex_DOT_unlockupgrade_and_lockshared(P3THREADS_tp3sharedmutex self) {
   P3THREADS_tp3mutex_DOT_lock(self->P3THREADS_tp3sharedmutex_DOT_statechange);
   self->P3THREADS_tp3sharedmutex_DOT_fstate.upgrade = SYSTEM_false;
   P3THREADS_tp3sharedmutex_DOT_releasewaiters(self);
   P3THREADS_tp3mutex_DOT_unlock(self->P3THREADS_tp3sharedmutex_DOT_statechange);
...
Procedure P3THREADS_incdt(SYSTEM_P3_tdatetime* dt, SYSTEM_cardinal ticks) {
   if (*dt < 0)
      return;
   *dt = *dt + ticks / P3THREADS_ticks_per_day;
}  /* incdt */

Procedure P3THREADS_decdt(SYSTEM_P3_tdatetime* dt, SYSTEM_cardinal ticks) {
   if (*dt < 0)
      return;
   *dt = *dt - ticks / P3THREADS_ticks_per_day;
   if (*dt < 0)
...
Function(P3THREADS_tcvtime) P3THREADS_encodedatecv(SYSTEM_word year, SYSTEM_word month, SYSTEM_word day) {
   ...
   if (month < 1 || month > 12)
      return result;
   daytable = ValueCast(SYSUTILS_P3_pdaytable, SYSUTILS_P3_monthdays[SYSUTILS_P3_isleapyear(year)]);
   ...
   ydays = ydays + ValueCast(SYSTEM_int32, year) / 4 - ValueCast(SYSTEM_int32, year) / 100 + ValueCast(SYSTEM_int32, year) / 400;
   _P3inc1(result, ydays);
   result = result * P3THREADS_nicksperday;
   return result;
}  /* encodedatecv */

Function(P3THREADS_tcvtime) P3THREADS_encodetimecv(SYSTEM_word hour, SYSTEM_word _min, SYSTEM_word sec, SYSTEM_word msec) {
   P3THREADS_tcvtime result;
   ...
   if (msec < 1 || msec > 1000)
      return result;
   result = (ValueCast(SYSTEM_int32, hour) - 1) * 60 + (ValueCast(SYSTEM_int32, _min) - 1);
...
P3THREADS_decodedatefullycv(P3THREADS_tcvtime cvt, SYSTEM_word* year, SYSTEM_word* month, SYSTEM_word* day, SYSTEM_word* dow) {
   SYSTEM_boolean result;
   SYSTEM_int64 d;
...
Procedure P3THREADS_decodedatecv(P3THREADS_tcvtime cvt, SYSTEM_word* year, SYSTEM_word* month, SYSTEM_word* day) {
   SYSTEM_word dow;

   P3THREADS_decodedatefullycv(cvt, year, month, day, &dow);
}  /* decodedatecv */

Procedure P3THREADS_decodetimecv(P3THREADS_tcvtime cvt, SYSTEM_word* hour, SYSTEM_word* _min, SYSTEM_word* sec, SYSTEM_word* msec) {
   SYSTEM_int64 nk;
   SYSTEM_int64 t;
...
Function(P3THREADS_tcvtime) P3THREADS_nowcv(void) {
...
#else
   {
      ...
      if (rc)
         return result;
      result = (SYSTEM_int64) tv.tv_sec * nicks_per_sec + (SYSTEM_int64) tv.tv_usec * nicks_per_usec + nicksperday * date_delta_cv_unix;
   }
#endif
   return result;
}  /* nowcv */
...
Procedure P3THREADS_inccvtimemillis(P3THREADS_tcvtime* cvt, SYSTEM_cardinal ticks) {
   _P3inc1(*cvt, ticks * P3THREADS_nicks_per_msec);
}  /* inccvtimemillis */

Procedure P3THREADS_deccvtimemillis(P3THREADS_tcvtime* cvt, SYSTEM_cardinal ticks) {
   _P3dec1(*cvt, ticks * P3THREADS_nicks_per_msec);
   if (*cvt < 0)
      *cvt = 0;
}  /* deccvtimemillis */

Function(SYSTEM_cardinal) P3THREADS_tickdeltacv(P3THREADS_tcvtime cvt) {
   SYSTEM_cardinal result;
...
void _Init_Module_p3threads(void) {
   ...
   P3THREADS_nickspermin = P3THREADS_nickspermin * P3THREADS_nicks_per_sec;
