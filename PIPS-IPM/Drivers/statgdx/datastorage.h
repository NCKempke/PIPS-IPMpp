...
typedef struct DATASTORAGE_tgamsdatasearcher_OD_S* DATASTORAGE_tgamsdatasearcher; /* sy_class */
extern void* const DATASTORAGE_tgamsdatasearcher_VT[];
extern const SYSTEM_classdescriptor_t DATASTORAGE_tgamsdatasearcher_CD;


typedef struct DATASTORAGE_tgamsdatastore_OD_S* DATASTORAGE_tgamsdatastore; /* sy_class */
...
DATASTORAGE_tgamsdatastore_DOT_create(
      DATASTORAGE_tgamsdatastore
self,
SYSTEM_integer adimension, SYSTEM_integer
adatasize,
...
DATASTORAGE_tgamsdatastore_DOT_comparekeys(
      DATASTORAGE_tgamsdatastore
self,
GMSGEN_pintegerarrayone key1, GMSGEN_pintegerarrayone
key2);
...
DATASTORAGE_tgamsdatastore_DOT_isdefaultdata(
      DATASTORAGE_tgamsdatastore
self,
...
(
DATASTORAGE_tgamsdatastore self, DATASTORAGE_tgamsdatasearcher
ads,
...
(
DATASTORAGE_tgamsdatastore self, GMSGEN_pintegerarrayone
akey,
const SYSTEM_untyped* adata
);
...
Function(SYSTEM_boolean )
DATASTORAGE_tgamsdatastore_DOT_startread(
      DATASTORAGE_tgamsdatastore
self);
...
Function(SYSTEM_boolean )
DATASTORAGE_tgamsdatastore_DOT_getnextrecord(
      DATASTORAGE_tgamsdatastore
self,
GMSGEN_pintegerarrayone akey, SYSTEM_untyped
*adata);
...
DATASTORAGE_tgamsdatasearcher self, GMSGEN_pintegerarrayone
akey,
...
DATASTORAGE_treclist_DOT_getitem(
      DATASTORAGE_treclist
self,
...
Constructor(DATASTORAGE_treclist )
DATASTORAGE_treclist_DOT_create(
      DATASTORAGE_treclist
self,
SYSTEM_integer arecsize
);

Destructor(DATASTORAGE_treclist )
DATASTORAGE_treclist_DOT_destroy(
      DATASTORAGE_treclist
self);

Function(SYSTEM_pointer )
DATASTORAGE_treclist_DOT_additem(
      DATASTORAGE_treclist
self);
...
Function(SYSTEM_pointer )
DATASTORAGE_treclist_DOT_insert(
      DATASTORAGE_treclist
self,
SYSTEM_integer index
);
...
typedef struct DATASTORAGE_tgamsdatatablesearcher_OD_S* DATASTORAGE_tgamsdatatablesearcher; /* sy_class */
...
typedef struct DATASTORAGE_tgamsdatatable_OD_S* DATASTORAGE_tgamsdatatable; /* sy_class */
...
Function(SYSTEM_integer )
DATASTORAGE_tgamsdatatable_DOT_getcount(
      DATASTORAGE_tgamsdatatable
self);

Function(SYSTEM_integer )
DATASTORAGE_tgamsdatatable_DOT_getcapacity(
      DATASTORAGE_tgamsdatatable
self);
...
Function(SYSTEM_integer )
DATASTORAGE_tgamsdatatable_DOT_memoryused(
      DATASTORAGE_tgamsdatatable
self);
...
Function(SYSTEM_P3_pbyte )
DATASTORAGE_tgamsdatatable_DOT_getnextkey(
      DATASTORAGE_tgamsdatatable
self,
GMSGEN_pintegerarrayone akey
);
...
DATASTORAGE_tgamsdatatablesearcher_DOT_startsearch(
      DATASTORAGE_tgamsdatatablesearcher
self);
...
DATASTORAGE_tgamsdatatablesearcher_DOT_search(
      DATASTORAGE_tgamsdatatablesearcher
self,
GMSGEN_pintegerarrayone akey, SYSTEM_pointer
*apdata);
extern void* const DATASTORAGE_tgamsdatatablesearcher_VT[];
extern const SYSTEM_classdescriptor_t DATASTORAGE_tgamsdatatablesearcher_CD;


typedef struct DATASTORAGE_tintegermapping_OD_S* DATASTORAGE_tintegermapping; /* sy_class */
...
Function(SYSTEM_integer )
DATASTORAGE_tintegermapping_DOT_getmapping(
...
Function(SYSTEM_integer )
DATASTORAGE_tintegermapping_DOT_memoryused(
      DATASTORAGE_tintegermapping
self);
...
typedef DATASTORAGE_tintegermappingarray* DATASTORAGE_pintegermappingarray;
typedef struct DATASTORAGE_tgamsdatafull_OD_S* DATASTORAGE_tgamsdatafull; /* sy_class */
...
Function(SYSTEM_P3_pbyte )
DATASTORAGE_tgamsdatafull_DOT_getoffset(
      DATASTORAGE_tgamsdatafull
self,
GMSGEN_pintegerarrayone akey
);

Function(SYSTEM_integer )
DATASTORAGE_tgamsdatafull_DOT_getcount(
      DATASTORAGE_tgamsdatafull
self);
...
Function(SYSTEM_integer )
DATASTORAGE_tgamsdatafull_DOT_memoryused(
      DATASTORAGE_tgamsdatafull
self);
...
typedef struct DATASTORAGE_tgamsdatafullsearcher_OD_S* DATASTORAGE_tgamsdatafullsearcher; /* sy_class */
...
DATASTORAGE_tgamsdatafullsearcher_DOT_search(
      DATASTORAGE_tgamsdatafullsearcher
self,
GMSGEN_pintegerarrayone akey, SYSTEM_pointer
*apdata);
...
typedef struct DATASTORAGE_tgamsdatasparse_OD_S* DATASTORAGE_tgamsdatasparse; /* sy_class */
...
Function(SYSTEM_integer )
DATASTORAGE_tgamsdatasparse_DOT_getcount(
      DATASTORAGE_tgamsdatasparse
self);

Function(SYSTEM_pointer )
DATASTORAGE_tgamsdatasparse_DOT_getcell(
      DATASTORAGE_tgamsdatasparse
self,
SYSTEM_integer d
);
...
Function(SYSTEM_integer )
DATASTORAGE_tgamsdatasparse_DOT_memoryused(
      DATASTORAGE_tgamsdatasparse
self);
...
Function(SYSTEM_boolean )
DATASTORAGE_tgamsdatasparse_DOT_startread(
      DATASTORAGE_tgamsdatasparse
self);

Function(SYSTEM_P3_pbyte )
DATASTORAGE_tgamsdatasparse_DOT_getnextkey(
      DATASTORAGE_tgamsdatasparse
self,
GMSGEN_pintegerarrayone akey
);
...
typedef struct DATASTORAGE_tgamsdatasparsesearcher_OD_S* DATASTORAGE_tgamsdatasparsesearcher; /* sy_class */
...
DATASTORAGE_tgamsdatasparsesearcher_DOT_create(
      DATASTORAGE_tgamsdatasparsesearcher
self,
...
Function(SYSTEM_boolean )
DATASTORAGE_tlinkeddata_DOT_removedefaults(
      DATASTORAGE_tlinkeddata
self,
...
Function(SYSTEM_integer )
DATASTORAGE_tlinkeddata_DOT_memoryused(
      DATASTORAGE_tlinkeddata
self);
...
Function(SYSTEM_pointer )
DATASTORAGE_tlinkeddata_DOT_additem(
      DATASTORAGE_tlinkeddata
self,
GMSGEN_pintegerarrayone akey,
const SYSTEM_untyped* adata
...
Function(SYSTEM_boolean )
DATASTORAGE_tlinkeddata_DOT_startread(
      DATASTORAGE_tlinkeddata
self,
SYSTEM_pointer* p, GMSGEN_pintegerarrayone
amap);

Function(SYSTEM_P3_pbyte )
DATASTORAGE_tlinkeddata_DOT_getnextkey(
      DATASTORAGE_tlinkeddata
self,
SYSTEM_pointer* p, GMSGEN_pintegerarrayone
akey);
...
Function(SYSTEM_boolean )
DATASTORAGE_tlinkeddata_DOT_getnextrecord(
      DATASTORAGE_tlinkeddata
self,
SYSTEM_pointer* p, GMSGEN_pintegerarrayone
akey,
...
typedef struct DATASTORAGE_tgamshashlist_OD_S* DATASTORAGE_tgamshashlist; /* sy_class */
...
Function(SYSTEM_integer )
DATASTORAGE_tgamshashlist_DOT_getcount(
      DATASTORAGE_tgamshashlist
self);

Function(SYSTEM_integer )
DATASTORAGE_tgamshashlist_DOT_hash(
      DATASTORAGE_tgamshashlist
self,
GMSGEN_pintegerarrayone akey
);
...
Function(SYSTEM_boolean )
DATASTORAGE_tgamshashlist_DOT_equalkeys(
      DATASTORAGE_tgamshashlist
self,
GMSGEN_pintegerarrayone akey1, GMSGEN_pintegerarrayone
akey2);
...
DATASTORAGE_tgamshashlist_DOT_create(
      DATASTORAGE_tgamshashlist
self,
SYSTEM_integer adim, SYSTEM_integer
adatasize);
...
Function(SYSTEM_pointer )
DATASTORAGE_tgamshashlist_DOT_indexof(
      DATASTORAGE_tgamshashlist
self,
GMSGEN_pintegerarrayone akey
);
...
Function(SYSTEM_boolean )
DATASTORAGE_tgamshashlist_DOT_additem(
      DATASTORAGE_tgamshashlist
self,
GMSGEN_pintegerarrayone akey,
const SYSTEM_untyped* adata
...
Function(SYSTEM_boolean )
DATASTORAGE_tgamshashlist_DOT_startread(
      DATASTORAGE_tgamshashlist
self);

Function(SYSTEM_P3_pbyte )
DATASTORAGE_tgamshashlist_DOT_getnextkey(
      DATASTORAGE_tgamshashlist
self,
GMSGEN_pintegerarrayone akey
);
...
Function(SYSTEM_integer )
DATASTORAGE_tgamshashlist_DOT_memoryused(
      DATASTORAGE_tgamshashlist
self);
...
typedef struct DATASTORAGE_tgamsdatahashedsearcher_OD_S* DATASTORAGE_tgamsdatahashedsearcher; /* sy_class */
...
typedef struct DATASTORAGE_tgamsdatahashed_OD_S* DATASTORAGE_tgamsdatahashed; /* sy_class */
...
Function(SYSTEM_integer )
DATASTORAGE_tgamsdatahashed_DOT_getcount(
      DATASTORAGE_tgamsdatahashed
self);
...
Function(SYSTEM_boolean )
DATASTORAGE_tgamsdatahashed_DOT_startread(
      DATASTORAGE_tgamsdatahashed
self);

Function(SYSTEM_P3_pbyte )
DATASTORAGE_tgamsdatahashed_DOT_getnextkey(
      DATASTORAGE_tgamsdatahashed
self,
GMSGEN_pintegerarrayone akey
);
...
Function(SYSTEM_integer )
DATASTORAGE_tgamsdatahashed_DOT_memoryused(
      DATASTORAGE_tgamsdatahashed
self);
...
DATASTORAGE_tgamsdatahashedsearcher_DOT_search(
      DATASTORAGE_tgamsdatahashedsearcher
self,
GMSGEN_pintegerarrayone akey, SYSTEM_pointer
*apdata);
extern void* const DATASTORAGE_tgamsdatahashedsearcher_VT[];
