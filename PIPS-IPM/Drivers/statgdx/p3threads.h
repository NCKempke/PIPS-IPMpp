...
cnstdef {
P3THREADS_p3_semsize = 64
};
cnstdef {
P3THREADS_p3_muxsize = 64
};
cnstdef {
P3THREADS_p3_condvarsize = 64
};
...
P3THREADS_tp3thread_DOT_getthreadid(
      P3THREADS_tp3thread
self);

Function(SYSTEM_boolean )
P3THREADS_tp3thread_DOT_semisnull(
      P3THREADS_tp3thread
self);

Function(SYSTEM_boolean )
P3THREADS_tp3thread_DOT_issuspended(
      P3THREADS_tp3thread
self);
...
Constructor(P3THREADS_tp3thread )
P3THREADS_tp3thread_DOT_create(
      P3THREADS_tp3thread
self,
SYSTEM_boolean createsuspended
);

Destructor(P3THREADS_tp3thread )
P3THREADS_tp3thread_DOT_destroy(
      P3THREADS_tp3thread
self);
...
P3THREADS_tp3thread_DOT_waitfor(
      P3THREADS_tp3thread
self);
...
Constructor(P3THREADS_tp3mutex )
P3THREADS_tp3mutex_DOT_create(
      P3THREADS_tp3mutex
self);

Destructor(P3THREADS_tp3mutex )
...
Function(SYSTEM_boolean )
P3THREADS_tp3mutex_DOT_trylock(
      P3THREADS_tp3mutex
self);
...
Constructor(P3THREADS_tp3condvar )
P3THREADS_tp3condvar_DOT_create(
      P3THREADS_tp3condvar
self);

Destructor(P3THREADS_tp3condvar )
...
Function(SYSTEM_boolean )
P3THREADS_tp3condvar_DOT_timedwaitabs(
      P3THREADS_tp3condvar
self,
P3THREADS_tp3mutex mx, P3THREADS_tcvtime
abstime);
...
Function(SYSTEM_boolean )
P3THREADS_tp3sharedmutex_DOT_trylock(
      P3THREADS_tp3sharedmutex
self);
...
Function(SYSTEM_boolean )
P3THREADS_tp3sharedmutex_DOT_trylockshared(
      P3THREADS_tp3sharedmutex
self);
...
Function(SYSTEM_boolean )
P3THREADS_tp3sharedmutex_DOT_trylockupgrade(
      P3THREADS_tp3sharedmutex
self);
...
Function(P3THREADS_tcvtime )
P3THREADS_encodedatecv(
      SYSTEM_word
year,
SYSTEM_word month, SYSTEM_word
day);

Function(P3THREADS_tcvtime )
P3THREADS_encodetimecv(
      SYSTEM_word
hour,
SYSTEM_word _min, SYSTEM_word
sec,
SYSTEM_word msec
);

Function(SYSTEM_boolean )
P3THREADS_decodedatefullycv(
      P3THREADS_tcvtime
cvt,
SYSTEM_word* year, SYSTEM_word
*month,
SYSTEM_word* day, SYSTEM_word
*dow);
...
Function(P3THREADS_tcvtime )
P3THREADS_nowcv(void);

Function(P3THREADS_tcvtime )
P3THREADS_datecv(void);

Function(P3THREADS_tcvtime )
P3THREADS_timecv(void);

Procedure P3THREADS_inccvtimemillis(P3THREADS_tcvtime * cvt, SYSTEM_cardinal
ticks);

Procedure P3THREADS_deccvtimemillis(P3THREADS_tcvtime * cvt, SYSTEM_cardinal
ticks);

Function(SYSTEM_cardinal )
P3THREADS_tickdeltacv(
      P3THREADS_tcvtime
cvt);
