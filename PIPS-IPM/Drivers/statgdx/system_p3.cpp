...
static Function(SYSTEM_P3_pansichar) SYSTEM_P3_getparamshortstr(SYSTEM_P3_pansichar p, SYSTEM_ansichar* param);
...
Function(SYSTEM_ansichar *) SYSTEM_P3_paramstr(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, SYSTEM_integer index) {
   SYSTEM_shortstring s;
...
Procedure SYSTEM_P3_getdir(SYSTEM_byte d, SYSTEM_ansichar* s) {
...
Procedure SYSTEM_P3_fillchar(SYSTEM_untyped* p, SYSTEM_integer len, SYSTEM_byte v) {
   /**** C code included from system_p3.pas(290:1): 1 lines ****/
   (void) memset(p, (int) v, (size_t) len);
}  /* fillchar */

Procedure SYSTEM_P3_settextbuf(SYSTEM_text* f, SYSTEM_untyped* p) {
}  /* settextbuf */
