...
cnstdef {
RUNNER_ec_cannot_modify = 1
};
cnstdef {
RUNNER_ec_process_active = 2
};
cnstdef {
RUNNER_ec_empty_cmd_line = 3
};
...
Constructor(RUNNER_tmsghandler )
RUNNER_tmsghandler_DOT_create(
      RUNNER_tmsghandler
self,
...
RUNNER_trunner_DOT_errorwhenrunning(
      RUNNER_trunner
self,
...
Constructor(RUNNER_trunner )
RUNNER_trunner_DOT_create(
      RUNNER_trunner
self);

Destructor(RUNNER_trunner )
RUNNER_trunner_DOT_destroy(
      RUNNER_trunner
self);
...
Function(SYSTEM_integer )
RUNNER_trunner_DOT_paramscount(
      RUNNER_trunner
self);

Function(SYSTEM_P3_pansichar )
RUNNER_trunner_DOT_commandline(
      RUNNER_trunner
self);

Function(SYSTEM_integer )
RUNNER_trunner_DOT_startandwait(
      RUNNER_trunner
self);
