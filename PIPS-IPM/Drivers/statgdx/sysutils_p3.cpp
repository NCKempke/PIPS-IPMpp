...
SYSTEM_ansichar SYSUTILS_P3_pathdelim, SYSUTILS_P3_drivedelim, SYSUTILS_P3_pathsep;
...
static SYSTEM_char* mkP3Msg(const char* txt, SYSTEM_shortstring msg) {
   int n;
...
static SYSTEM_char* mkP3Msg2(const char* txt1, const char* txt2, SYSTEM_shortstring msg) {
   int n;
...
static Procedure SYSUTILS_P3_divmod(SYSTEM_integer dividend, SYSTEM_word divisor, SYSTEM_word* result, SYSTEM_word* remainder) {
   SYSTEM_integer quotient;

   if (dividend < 0)
      _P3_RAISE(ValueCast(EXCEPTIONS_eintoverflow,
            SYSTEM_exception_DOT_create(ValueCast(SYSTEM_exception, _P3alloc_object(&EXCEPTIONS_eintoverflow_CD)), _P3str1("\020Integer overflow"))));
   if (divisor == 0)
      _P3_RAISE(ValueCast(EXCEPTIONS_edivbyzero,
            SYSTEM_exception_DOT_create(ValueCast(SYSTEM_exception, _P3alloc_object(&EXCEPTIONS_edivbyzero_CD)), _P3str1("\020Division by zero"))));
...
Function(SYSTEM_pointer) SYSUTILS_P3_allocmem(SYSTEM_cardinal sz) {
...
Function(SYSTEM_ansichar *) SYSUTILS_P3_uppercase(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* s) {
   SYSTEM_integer l;
...
Function(SYSTEM_ansichar *) SYSUTILS_P3_lowercase(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* s) {
   SYSTEM_integer l;
...
Function(SYSTEM_integer) SYSUTILS_P3_comparestr(const SYSTEM_ansichar* s1, const SYSTEM_ansichar* s2) {
   ...
   result = ValueCast(SYSTEM_int32, SYSTEM_length(s1)) - SYSTEM_length(s2);
   return result;
}  /* comparestr */

Function(SYSTEM_integer) SYSUTILS_P3_comparetext(const SYSTEM_ansichar* s1, const SYSTEM_ansichar* s2) {
   SYSTEM_integer result;
   SYSTEM_integer i;
   SYSTEM_integer m;
      ...
      m = SYSTEM_length(s2);
   {
      ...
      if ((i = 1) <= _stop)
         do {
            result = SYSTEM_ord(SYSTEM_upcase(s1[i])) - SYSTEM_ord(SYSTEM_upcase(s2[i]));
            if (result != 0)
               return result;
...
Function(SYSTEM_boolean) SYSUTILS_P3_sametext(const SYSTEM_ansichar* s1, const SYSTEM_ansichar* s2) {
...
Function(SYSTEM_ansichar *) SYSUTILS_P3_trim(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* s) {
   SYSTEM_integer i, l;
...
Function(SYSTEM_ansichar *) SYSUTILS_P3_trimleft(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* s) {
   SYSTEM_integer i, l;
...
Function(SYSTEM_ansichar *) SYSUTILS_P3_trimright(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* s) {
   SYSTEM_integer i;
...
Function(SYSTEM_ansichar *) SYSUTILS_P3_inttostr(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, SYSTEM_int64 n) {
   SYSTEM_int64 w, w2;
...
Function(SYSTEM_ansichar *) SYSUTILS_P3_inttohex(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, SYSTEM_int64 v, SYSTEM_integer w) {
...
Function(SYSTEM_integer) SYSUTILS_P3_strtoint(const SYSTEM_ansichar* s) {
   SYSTEM_integer result;
   SYSTEM_int64 res;
...
Function(SYSTEM_int64) SYSUTILS_P3_strtoint64(const SYSTEM_ansichar* s) {
   SYSTEM_int64 result;
   SYSTEM_int64 res;
   SYSTEM_integer i;
   ...
   if (hex) {
      while (i <= ValueCast(SYSTEM_int32, SYSTEM_length(s))) {
         ...
         else if (_P3SET_in_3(s[i], _P3char('A'), _P3char('F'))) {
...
Function(SYSTEM_integer) SYSUTILS_P3_fileage(const SYSTEM_ansichar* filename) {
   SYSTEM_integer result;
...
Function(SYSTEM_boolean) SYSUTILS_P3_fileexists(const SYSTEM_ansichar* filename) {
   SYSTEM_boolean result;
...
Function(SYSTEM_boolean) SYSUTILS_P3_directoryexists(const SYSTEM_ansichar* directory) {
   SYSTEM_boolean result;
...
static Function(SYSTEM_integer) SYSUTILS_P3_findmatchingfile(SYSUTILS_P3_tsearchrec* f) {
   SYSTEM_integer result;
            ...
            if (0 == rc) {
               ...
               if (S_ISDIR(mode))
                  ...
                  if (S_ISLNK(mode)) {
                     ...
                     if (0 == lstat(fname, &linkstatbuf) && S_ISDIR(linkstatbuf.st_mode))
                        attr |= SYSUTILS_P3_fadirectory;
                  }
...
Function(SYSTEM_integer) SYSUTILS_P3_findfirst(const SYSTEM_ansichar* path, SYSTEM_integer attr, SYSUTILS_P3_tsearchrec* f) {
   SYSTEM_integer result;
   ...
   f->excludeattr = f->excludeattr & faspecial;
   {
      ...
      _P3strcpy(f->pathonly, 255, SYSUTILS_P3_extractfilepath(_t1, 255, path));
   }
   {
      SYSTEM_shortstring _t1;

      _P3strcpy(f->pattern, 255, SYSUTILS_P3_extractfilename(_t1, 255, path));
   }
   if (_P3strcmpE(f->pathonly, _P3str1("\000"))) {
      SYSTEM_shortstring _t1;
      SYSTEM_shortstring _t2;

      _P3strcpy(f->pathonly, 255, SYSUTILS_P3_includetrailingpathdelimiter(_t1, 255, SYSUTILS_P3_getcurrentdir(_t2, 255)));
   }
...
Function(SYSTEM_integer) SYSUTILS_P3_findnext(SYSUTILS_P3_tsearchrec* f) {
   SYSTEM_integer result;
...
Procedure SYSUTILS_P3_findclose(SYSUTILS_P3_tsearchrec* f) {
...
Function(SYSTEM_boolean) SYSUTILS_P3_deletefile(const SYSTEM_ansichar* filename) {
   SYSTEM_boolean result;
...
Function(SYSTEM_boolean) SYSUTILS_P3_renamefile(const SYSTEM_ansichar* oldname, const SYSTEM_ansichar* newname) {
   SYSTEM_boolean result;
...
Function(SYSTEM_integer) SYSUTILS_P3_lastdelimiter(const SYSTEM_ansichar* delimiters, const SYSTEM_ansichar* s) {
   SYSTEM_integer result;
   SYSTEM_integer i;
...
Function(SYSTEM_ansichar *) SYSUTILS_P3_changefileext(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* filename,
      ...
      i = i - 1;
   {
      ...
      _P3strcat(result, _len_ret, SYSTEM_copy(_t1, 255, filename, 1, i), extension);
   }
   return result;
}  /* changefileext */

Function(SYSTEM_ansichar *) SYSUTILS_P3_extractfilepath(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* filename) {
   SYSTEM_integer i;

   {
      ...
      i = SYSUTILS_P3_lastdelimiter(_P3strcat(_t3, 2, _P3ch2str(_t1, 1, SYSUTILS_P3_pathdelim), _P3ch2str(_t2, 1, SYSUTILS_P3_drivedelim)), filename);
   }
   SYSTEM_copy(result, _len_ret, filename, 1, i);
   return result;
}  /* extractfilepath */

Function(SYSTEM_ansichar *) SYSUTILS_P3_extractfiledir(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* filename) {
   SYSTEM_integer i;
   ...
   if (i > 1 && filename[i] == SYSUTILS_P3_pathdelim)
      if (filename[i - 1] != SYSUTILS_P3_pathdelim && filename[i - 1] != SYSUTILS_P3_drivedelim)
         _P3dec0(i);
   SYSTEM_copy(result, _len_ret, filename, 1, i);
   return result;
}  /* extractfiledir */

Function(SYSTEM_ansichar *) SYSUTILS_P3_extractfilename(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* filename) {
   SYSTEM_integer i;
...
Function(SYSTEM_ansichar *) SYSUTILS_P3_extractfileext(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* filename) {
   SYSTEM_integer i;
...
Function(SYSTEM_ansichar *) SYSUTILS_P3_extractshortpathname(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* filename) {
...
Function(SYSTEM_P3_tdatetime) SYSUTILS_P3_filedatetodatetime(SYSTEM_integer filedate) {
   ...
   if (P3PLATFORM_osfiletype() == P3PLATFORM_osfilewin) {
      ...
      result = SYSUTILS_P3_encodedate(year, month, day) + SYSUTILS_P3_encodetime(hour, minu, sec, 0);
      return result;
   }
   /**** C code included from sysutils_p3.pas(1336:1): 11 lines ****/
   {
      ...
      tim = filedate;
      localtime_r(&tim, &ut);
      result = SYSUTILS_P3_encodedate(ut.tm_year + 1900, ut.tm_mon + 1, ut.tm_mday) + SYSUTILS_P3_encodetime(ut.tm_hour, ut.tm_min, ut.tm_sec, 0);
#endif
   }
   return result;
}  /* filedatetodatetime */

Function(SYSTEM_integer) SYSUTILS_P3_datetimetofiledate(SYSTEM_P3_tdatetime datetime) {
   SYSTEM_integer result;
   SYSUTILS_P3_longrec rec;
   ...
   if (P3PLATFORM_osfiletype() == P3PLATFORM_osfilewin) {
      if (year < 1980 || year > 2107) {
         ...
         lo = ValueCast(SYSTEM_int32, sec >> 1) | minu << 5 | hour << 11;
         hi = ValueCast(SYSTEM_int32, day) | month << 5 | ValueCast(SYSTEM_uint32, ValueCast(SYSTEM_int32, year) - 1980) << 9;
         rec._u._c1.lo = lo;
         rec._u._c1.hi = hi;
...
Function(SYSTEM_ansichar *) SYSUTILS_P3_getcurrentdir(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret) {
   SYSTEM_boolean isok;
   ...
   if (!isok)
      _P3_RAISE(ValueCast(SYSTEM_exception, SYSTEM_exception_DOT_create(ValueCast(SYSTEM_exception, _P3alloc_object(&SYSTEM_exception_CD)), emsg)));
   return result;
}  /* getcurrentdir */

Function(SYSTEM_boolean) SYSUTILS_P3_setcurrentdir(const SYSTEM_ansichar* dir) {
   SYSTEM_boolean result;
...
Function(SYSTEM_boolean) SYSUTILS_P3_createdir(const SYSTEM_ansichar* dir) {
   SYSTEM_boolean result;
...
Function(SYSTEM_boolean) SYSUTILS_P3_removedir(const SYSTEM_ansichar* dir) {
   SYSTEM_boolean result;
...
Function(SYSTEM_cardinal) SYSUTILS_P3_strlen(SYSTEM_P3_pansichar str) {
...
Function(SYSTEM_P3_pansichar) SYSUTILS_P3_strpcopy(SYSTEM_P3_pansichar dest, const SYSTEM_ansichar* src) {
...
Function(SYSTEM_ansichar *) SYSUTILS_P3_floattostr(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, SYSTEM_double v) {
   _P3STR_95 s;
...
Function(SYSUTILS_P3_ttimestamp *) SYSUTILS_P3_datetimetotimestamp(SYSUTILS_P3_ttimestamp* result, SYSTEM_P3_tdatetime datetime) {
   SYSTEM_int64 i8;
   SYSTEM_double x;
...
Function(SYSTEM_P3_tdatetime) SYSUTILS_P3_timestamptodatetime(const SYSUTILS_P3_ttimestamp* timestamp) {
   SYSTEM_P3_tdatetime result;
...
Function(SYSTEM_boolean) SYSUTILS_P3_tryencodetime(SYSTEM_word hour, SYSTEM_word _min, SYSTEM_word sec, SYSTEM_word msec, SYSTEM_P3_tdatetime* time) {
   SYSTEM_boolean result;

   result = SYSTEM_false;
   if (hour < SYSUTILS_P3_hoursperday && _min < SYSUTILS_P3_minsperhour && sec < SYSUTILS_P3_secspermin && msec < SYSUTILS_P3_msecspersec) {
      *time = ValueCast(SYSTEM_double, hour * (3600000) + _min * (60000) + ValueCast(SYSTEM_int32, sec) * SYSUTILS_P3_msecspersec + msec) /
...
Function(SYSTEM_P3_tdatetime) SYSUTILS_P3_encodetime(SYSTEM_word hour, SYSTEM_word _min, SYSTEM_word sec, SYSTEM_word msec) {
   SYSTEM_P3_tdatetime result;
   SYSTEM_double mday;

   mday = 86400000;
   result = (hour * 3600000 + ValueCast(SYSTEM_int32, _min) * 60000 + ValueCast(SYSTEM_int32, sec) * 1000 + msec) / mday;
   return result;
}  /* encodetime */

Procedure SYSUTILS_P3_decodetime(SYSTEM_P3_tdatetime datetime, SYSTEM_word* hour, SYSTEM_word* _min, SYSTEM_word* sec, SYSTEM_word* msec) {
   SYSTEM_word mincount, mseccount;

   {
      SYSUTILS_P3_ttimestamp _t1;

      SYSUTILS_P3_divmod(SYSUTILS_P3_datetimetotimestamp(&_t1, datetime)->time, 60000, &mincount, &mseccount);
   }
...
Function(SYSTEM_boolean) SYSUTILS_P3_isleapyear(SYSTEM_word year) {
   SYSTEM_boolean result;

   result = ValueCast(SYSTEM_int32, year) % 4 == 0 && ValueCast(SYSTEM_int32, year) % 4000 != 0 &&
            (ValueCast(SYSTEM_int32, year) % 100 != 0 || ValueCast(SYSTEM_int32, year) % 400 == 0);
   return result;
}  /* isleapyear */

Function(SYSTEM_boolean) SYSUTILS_P3_tryencodedate(SYSTEM_word year, SYSTEM_word month, SYSTEM_word day, SYSTEM_P3_tdatetime* date) {
   SYSTEM_boolean result;
   SYSTEM_integer i;
   ...
   if (year >= 1 && year <= 9999 && month >= 1 && month <= 12 && day >= 1 && day <= (*daytable)[month - 1]) {
      ...
      *date = i * 365 + i / 4 - i / 100 + i / 400 + day - SYSUTILS_P3_datedelta;
      result = SYSTEM_true;
   }
   return result;
}  /* tryencodedate */

Function(SYSTEM_P3_tdatetime) SYSUTILS_P3_encodedate(SYSTEM_word year, SYSTEM_word month, SYSTEM_word day) {
   SYSTEM_P3_tdatetime result;
   SYSTEM_longint yr;
   ...
   if (year == 1600 && month < 3) {
      ...
      result = yr / 100 * 146097 / 4 + yr % 100 * 1461 / 4 + (153 * month + 2) / 5 + day + 59 - 109572 + 1;
   }
   return result;
}  /* encodedate */

Function(SYSTEM_boolean)
SYSUTILS_P3_decodedatefully(SYSTEM_P3_tdatetime datetime, SYSTEM_word* year, SYSTEM_word* month, SYSTEM_word* day, SYSTEM_word* dow) {
   SYSTEM_boolean result;
   cnstdef { d1 = 365 };
   cnstdef { d4 = 1461 };
   cnstdef { d100 = 36524 };
   ...
   if (t <= 0) {
      ...
      *dow = t % 7 + 1;
      ...
      daytable = ValueCast(SYSUTILS_P3_pdaytable, SYSUTILS_P3_monthdays[result]);
      m = 1;
      while (SYSTEM_true) {
         i = (*daytable)[m - 1];
         if (d < i)
...
Procedure SYSUTILS_P3_decodedate(SYSTEM_P3_tdatetime datetime, SYSTEM_word* year, SYSTEM_word* month, SYSTEM_word* day) {
   SYSTEM_word dummy;
...
Function(SYSTEM_ansichar *) SYSUTILS_P3_syserrormessage(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, SYSTEM_integer errorcode) {
...
Function(SYSTEM_ansichar *) SYSUTILS_P3_includetrailingpathdelimiter(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* s) {
   if (SYSTEM_length(s) > 0 && SYSUTILS_P3_pathdelim == s[SYSTEM_length(s)]) {
      _P3strcpy(result, _len_ret, s);
   }
   else {
      _P3STR_3 _t1;

      _P3strcat(result, _len_ret, s, _P3ch2str(_t1, 1, SYSUTILS_P3_pathdelim));
   }
   return result;
}  /* includetrailingpathdelimiter */

Function(SYSTEM_ansichar *) SYSUTILS_P3_excludetrailingpathdelimiter(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* s) {
   _P3strcpy(result, _len_ret, s);
   if (SYSTEM_length(s) > 0 && SYSUTILS_P3_pathdelim == result[SYSTEM_length(result)])
      _P3setlength(result, ValueCast(SYSTEM_int32, SYSTEM_length(result)) - 1, 255);
   return result;
}  /* excludetrailingpathdelimiter */

Procedure SYSUTILS_P3_sleep(SYSTEM_cardinal milliseconds) {
...
Procedure SYSUTILS_P3_freeandnil(SYSTEM_untyped* obj) {
   SYSTEM_tobject temp;
...
Function(SYSTEM_ansichar *) SYSUTILS_P3_getenvironmentvariable(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* name) {
