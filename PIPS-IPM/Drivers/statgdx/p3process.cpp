...
void* const P3PROCESS_texecarglist_VT[] = {(void*) &P3PROCESS_texecarglist_DOT_destroy};

/* Class descriptor for 'texecarglist' */
const SYSTEM_classdescriptor_t P3PROCESS_texecarglist_CD = {_P3str1("\014texecarglist"), &SYSTEM_tobject_CD, NULL, 0,
                                                            sizeof(P3PROCESS_texecarglist_OD), P3PROCESS_texecarglist_VT, NULL};

static _P3STR_31 P3PROCESS_cmd_win7 = {27, 'c', ':', '\\', 'w', 'i', 'n', 'd', 'o', 'w', 's', '\\', 's', 'y', 's', 't', 'e', 'm', '3', '2', '\\', 'c',
                                       'm', 'd', '.', 'e', 'x', 'e'};
static _P3STR_31 P3PROCESS_cmd_winnt = {25, 'c', ':', '\\', 'w', 'i', 'n', 'n', 't', '\\', 's', 'y', 's', 't', 'e', 'm', '3', '2', '\\', 'c', 'm',
                                        'd', '.', 'e', 'x', 'e'};
...
static Function(SYSTEM_integer) asyncsystem4unix(SYSTEM_P3_pansichar cmdptr, P3PROCESS_tprocinfo* procinfo, SYSTEM_ansichar* msg);

static Function(SYSTEM_integer)
asyncsystem4win(SYSTEM_P3_pansichar cmdptr, SYSTEM_boolean newconsole, SYSTEM_boolean inheritedhandles, P3PROCESS_tprocinfo* procinfo,
      SYSTEM_ansichar* msg);
...
static Function(SYSTEM_ansichar *) P3PROCESS_whatquote(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* arg) {
   SYSTEM_integer i;
   ...
   if (SYSTEM_length(targ) > 1 && targ[1] == _P3char('\"') && targ[SYSTEM_length(targ)] == _P3char('\"'))
      return result;
...
int Win32CreateProc(const char* exeName, char* cmdLine, int inheritedHandles, int* exeRC)
#if !defined(_WIN32)
{
   *exeRC = *exeName + *cmdLine;
   return 1;
} /*  bogus definition */
#else
{
...
int Win32CreateProcEx(const char* exeName, char* cmdLine, int inheritedHandles, int* exeRC, int* errCode, char errMsg[256])
#if !defined(_WIN32)
{
   *exeRC = *exeName + *cmdLine;
   *errCode = 0;
...
int win32ASyncCreateProc(const char* exeName, char* cmdLine, int newConsole, int inheritedHandles, P3PROCESS_pprocinfo procInfo)
#if !defined(_WIN32)
{
   procInfo->pid = ~0;
   return 1; /* failure */
...
int LibcForkExecEx(int argc, char* const argv[], int* exeRC, int* errCode, char errMsg[256])
#if defined(_WIN32)
 ...
 */
int libcASyncForkExec(int argc, char* const argv[], SYSTEM_cardinal* pid)
#if defined(_WIN32)
{
  *pid = 0;
  return 1;
...
static Function(SYSTEM_P3_pansichar) P3PROCESS_getparamshortstr(SYSTEM_P3_pansichar p, SYSTEM_ansichar* param);

static Procedure pushchar(SYSTEM_ansichar c, SYSTEM_P3_pansichar* _2r, SYSTEM_integer* _2len) {
   if (*_2len < 255) {
      **_2r = c;
      _P3inc0(*_2len);
      _P3inc0(*_2r);
...
Function(SYSTEM_integer) P3PROCESS_p3execp(SYSTEM_P3_pansichar cmdptr, SYSTEM_integer* progrc) {
   ...
   switch (P3PLATFORM_osfiletype()) {
      ...
      case P3PLATFORM_osfileunix:
         ...
         _P3freemem(pargv);
         break;
      default: SYSTEM_assert(SYSTEM_false, _P3str1("\044unimplemented P3ExecP for OSFileType"));
   }
   return result;
}  /* p3execp */

Function(SYSTEM_integer) P3PROCESS_p3exec(const SYSTEM_ansichar* cmd, SYSTEM_integer* progrc) {
   SYSTEM_integer result;
...
Function(SYSTEM_integer) P3PROCESS_p3exec2(const SYSTEM_ansichar* progname, const SYSTEM_ansichar* progparams, SYSTEM_integer* progrc) {
   SYSTEM_integer result;
   ...
   switch (P3PLATFORM_osfiletype()) {
      case P3PLATFORM_osfilewin:
         cmdlen = ValueCast(SYSTEM_int32, SYSTEM_length(progname)) + 3 + SYSTEM_length(progparams) + 1;
      ...
      case P3PLATFORM_osfileunix:
         ...
         _P3freemem(pargv);
         break;
      default: SYSTEM_assert(SYSTEM_false, _P3str1("\044unimplemented P3Exec2 for OSFileType"));
   }
   return result;
}  /* p3exec2 */

Function(SYSTEM_integer) P3PROCESS_p3execl(const SYSTEM_ansichar* progname, P3PROCESS_texecarglist progparams, SYSTEM_integer* progrc) {
   SYSTEM_integer result;
   ...
   inheritedhandles = progparams->P3PROCESS_texecarglist_DOT_finheritedhandles;
   argc = 0;
   switch (P3PLATFORM_osfiletype()) {
      case P3PLATFORM_osfilewin:
         cmdlen = ValueCast(SYSTEM_int32, SYSTEM_length(progname)) + 3;
         {
            register SYSTEM_int32 _stop = progparams->P3PROCESS_texecarglist_DOT_fcount - 1;
            if ((i = 0) <= _stop)
               do {
                  {
                     SYSTEM_shortstring _t1;

                     cmdlen = cmdlen + SYSTEM_length(P3PROCESS_texecarglist_DOT_get(_t1, 255, progparams, i)) + 3;
                  }
               } while (i++ != _stop);
               ...
               do {
                  {
                     ...
                     _P3strcpy(quote, 255, P3PROCESS_whatquote(_t1, 255, P3PROCESS_texecarglist_DOT_get(_t2, 255, progparams, i)));
                  }
                  P3PRIVATE_pcharconcatstr(cmdptr, &k, _P3str1("\001 "));
                  P3PRIVATE_pcharconcatstr(cmdptr, &k, quote);
                  {
                     ...
                     P3PRIVATE_pcharconcatstr(cmdptr, &k, P3PROCESS_texecarglist_DOT_get(_t1, 255, progparams, i));
                  }
                  P3PRIVATE_pcharconcatstr(cmdptr, &k, quote);
      ...
      case P3PLATFORM_osfileunix:
               ...
               do {
                  {
                     ...
                     (*pargv)[i + 1] = P3PRIVATE_strtopchar(P3PROCESS_texecarglist_DOT_get(_t1, 255, progparams, i));
                  }
               } while (i++ != _stop);
         ...
         (*pargv)[argc] = NULL;
         break;
      default: SYSTEM_assert(SYSTEM_false, _P3str1("\044unimplemented P3Execl for OSFileType"));
   }
...
P3PROCESS_p3exexec2(const SYSTEM_ansichar* progname, const SYSTEM_ansichar* progparams, SYSTEM_integer* progrc, SYSTEM_integer* errcode,
   ...
   switch (P3PLATFORM_osfiletype()) {
      case P3PLATFORM_osfilewin:
         ...
         result = Win32CreateProcEx(NULL, (char*) cmdptr, 1, progrc, errcode, (char*) errmsgbuf);
         {
            ...
            _P3strcpy(errmsg, 255, P3PRIVATE_strbuftostr(_t1, 255, errmsgbuf));
         }
         _P3freemem(cmdptr);
         break;
      case P3PLATFORM_osfileunix:
         ...
         _P3freemem(pargv);
         break;
      default: SYSTEM_assert(SYSTEM_false, _P3str1("\046unimplemented P3ExExec2 for OSFileType"));
   }
   return result;
}  /* p3exexec2 */

Function(SYSTEM_integer)
P3PROCESS_p3asyncexecp(SYSTEM_P3_pansichar cmdptr, SYSTEM_boolean newconsole, P3PROCESS_tprocinfo* procinfo, SYSTEM_ansichar* msg) {
   SYSTEM_integer result;
   SYSTEM_integer argc, i;
   P3PROCESS_tpargv pargv;
   SYSTEM_P3_pansichar s;
   ...
   switch (P3PLATFORM_osfiletype()) {
      ...
      case P3PLATFORM_osfileunix:
         ...
         _P3freemem(pargv);
         break;
      default: SYSTEM_assert(SYSTEM_false, _P3str1("\051unimplemented p3ASyncExecP for OSFileType"));
   }
   return result;
}  /* p3asyncexecp */

Function(SYSTEM_integer)
P3PROCESS_p3asyncsystemp(SYSTEM_P3_pansichar cmdptr, SYSTEM_boolean newconsole, P3PROCESS_tprocinfo* procinfo, SYSTEM_ansichar* msg) {
   SYSTEM_integer result;
   ...
   switch (P3PLATFORM_osfiletype()) {
      case P3PLATFORM_osfilewin:
         result = asyncsystem4win(cmdptr, newconsole, SYSTEM_true, procinfo, msg);
         break;
      case P3PLATFORM_osfileunix:
         result = asyncsystem4unix(cmdptr, procinfo, msg);
         break;
      default: SYSTEM_assert(SYSTEM_false, _P3str1("\053unimplemented p3ASyncSystemP for OSFileType"));
   }
   return result;
}  /* p3asyncsystemp */

Function(SYSTEM_integer) P3PROCESS_p3asyncstatus(P3PROCESS_tprocinfo* procinfo, SYSTEM_integer* progrc, SYSTEM_ansichar* msg) {
   SYSTEM_integer result;
...
Function(SYSTEM_boolean) P3PROCESS_p3ispidvalid(SYSTEM_cardinal pid) {
...
Function(SYSTEM_boolean) P3PROCESS_p3ispidrunning(SYSTEM_cardinal pid) {
   SYSTEM_boolean result;
...
Function(SYSTEM_boolean) P3PROCESS_p3killprocess(const P3PROCESS_tprocinfo* procinfo, P3PROCESS_tkillhow how) {
   SYSTEM_boolean result;
...
Function(SYSTEM_boolean) P3PROCESS_p3killprocgrouptp(const P3PROCESS_tprocinfo* procinfo, P3PROCESS_tkillhow how) {
   SYSTEM_boolean result;
...
Function(SYSTEM_boolean) P3PROCESS_p3killprocgrouptk(const P3PROCESS_tprocinfo* procinfo, P3PROCESS_tkillhow how) {
   SYSTEM_boolean result;
...
Function(SYSTEM_integer) P3PROCESS_p3signalproctree(SYSTEM_integer signal, SYSTEM_integer* nchildrenpre, SYSTEM_integer* nchildrenpost) {
   SYSTEM_integer result;
...
Function(SYSTEM_integer)
P3PROCESS_p3walkproctree(SYSTEM_cardinal pid, P3PROCESS_tproctreecb cbfunc, SYSTEM_pointer usermem, SYSTEM_boolean postorder) {
   SYSTEM_integer result;
...
static Function(SYSTEM_integer) P3PROCESS_system4unix(SYSTEM_P3_pansichar cmdptr, SYSTEM_integer* progrc) {
   SYSTEM_integer result;
...
asyncsystem4win(SYSTEM_P3_pansichar cmdptr, SYSTEM_boolean newconsole, SYSTEM_boolean inheritedhandles, P3PROCESS_tprocinfo* procinfo,
   ...
   if (_P3strcmpE(cs, _P3str1("\000")))
      ...
      else if (SYSUTILS_P3_fileexists(P3PROCESS_cmd_winnt)) {
   ...
   if (*cmdptr == _P3char('\000')) {
      ...
      arglen = SYSUTILS_P3_strlen(csptr) + 5 + SYSUTILS_P3_strlen(cmdptr);
      _P3getmem(argptr, arglen);
      arglen = 0;
      P3PRIVATE_pcharconcatstr(argptr, &arglen, cs);
...
static Function(SYSTEM_integer) P3PROCESS_system4win(SYSTEM_P3_pansichar cmdptr, SYSTEM_boolean inheritedhandles, SYSTEM_integer* progrc) {
   SYSTEM_integer result;
   SYSTEM_shortstring cs;
   SYSTEM_P3_pansichar csptr;
   P3PRIVATE_shortstrbuf csbuf;
...
Function(SYSTEM_integer) P3PROCESS_p3system(const SYSTEM_ansichar* cmd, SYSTEM_integer* progrc) {
   SYSTEM_integer result;
   SYSTEM_P3_pansichar cmdptr;
   P3PRIVATE_shortstrbuf cmdbuf;
   ...
   switch (P3PLATFORM_osfiletype()) {
      ...
      case P3PLATFORM_osfileunix:
         ...
         break;
      default: SYSTEM_assert(SYSTEM_false, _P3str1("\045unimplemented P3system for OSFileType"));
   }
   return result;
}  /* p3system */

Function(SYSTEM_integer) P3PROCESS_p3systemp(SYSTEM_P3_pansichar cmdptr, SYSTEM_integer* progrc) {
   SYSTEM_integer result;
   ...
   switch (P3PLATFORM_osfiletype()) {
      ...
      case P3PLATFORM_osfileunix:
         result = P3PROCESS_system4unix(cmdptr, progrc);
         break;
      default: SYSTEM_assert(SYSTEM_false, _P3str1("\046unimplemented P3SystemP for OSFileType"));
   }
   return result;
}  /* p3systemp */

Function(SYSTEM_integer) P3PROCESS_p3system2(const SYSTEM_ansichar* progname, const SYSTEM_ansichar* progparams, SYSTEM_integer* progrc) {
   SYSTEM_integer result;
   SYSTEM_P3_pansichar cmdptr;
   SYSTEM_integer cmdlen;
   SYSTEM_integer k;

   cmdlen = ValueCast(SYSTEM_int32, SYSTEM_length(progname)) + 1 + SYSTEM_length(progparams);
   ...
   switch (P3PLATFORM_osfiletype()) {
      ...
      case P3PLATFORM_osfileunix:
         result = P3PROCESS_system4unix(cmdptr, progrc);
         break;
      default: SYSTEM_assert(SYSTEM_false, _P3str1("\046unimplemented P3system2 for OSFileType"));
   }
   _P3freemem(cmdptr);
   return result;
}  /* p3system2 */

Function(SYSTEM_integer) P3PROCESS_p3systeml(const SYSTEM_ansichar* progname, P3PROCESS_texecarglist progparams, SYSTEM_integer* progrc) {
   SYSTEM_integer result;
   SYSTEM_boolean inheritedhandles;
   SYSTEM_P3_pansichar cmdptr;
   SYSTEM_integer cmdlen;
   ...
   switch (P3PLATFORM_osfiletype()) {
      ...
      case P3PLATFORM_osfileunix:
         result = P3PROCESS_system4unix(cmdptr, progrc);
         break;
      default: SYSTEM_assert(SYSTEM_false, _P3str1("\046unimplemented P3systemL for OSFileType"));
   }
   _P3freemem(cmdptr);
   return result;
}  /* p3systeml */
...
static Function(SYSTEM_P3_pansichar) P3PROCESS_unixgetcommandline(void) {
         ...
         do {
            {
               ...
               _P3strcpy(s, 255, VariableCast(SYSTEM_shortstring, SYSTEM_P3_paramstr(_t1, 255, i), SYSTEM_shortstring));
            }
   ...
   P3PRIVATE_pcharconcatstr(result, &k, _P3str1("\001\""));
   {
      ...
      P3PRIVATE_pcharconcatstr(result, &k, VariableCast(SYSTEM_shortstring, SYSTEM_P3_paramstr(_t1, 255, 0), SYSTEM_shortstring));
   }
      ...
      if ((i = 1) <= _stop)
         do {
            ...
            P3PRIVATE_pcharconcatstr(result, &k, _P3str1("\001 "));
            {
               ...
               P3PRIVATE_pcharconcatstr(result, &k, VariableCast(SYSTEM_shortstring, SYSTEM_P3_paramstr(_t1, 255, i), SYSTEM_shortstring));
            }
...
Function(SYSTEM_integer) P3PROCESS_p3installctrlhandler(P3PROCESS_tctrlhandler newhandler) {
   SYSTEM_integer result;
   SYSTEM_integer rc;
   ...
   if (ValueCast(SYSTEM_pointer, P3PROCESS_ctrlhandler) != NULL) {
      ...
      P3PROCESS_ctrlhandler = ValueCast(P3PROCESS_tctrlhandler, newhandler);
   }
   else
...
static Function(SYSTEM_ansichar *) P3PROCESS_getstring(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, SYSTEM_P3_pshortstring ps) {
   if (ps == NULL) {
      _P3strclr(result);
   }
   else
...
static Function(SYSTEM_P3_pshortstring) P3PROCESS_newstring(const SYSTEM_ansichar* s) {
...
static Procedure P3PROCESS_disposestring(SYSTEM_P3_pshortstring ps) {
   if (ps != NULL)
      _P3freemem2(ps, ValueCast(SYSTEM_int32, SYSTEM_length(*ps)) + 1);
}  /* disposestring */

Constructor(P3PROCESS_texecarglist) P3PROCESS_texecarglist_DOT_create(P3PROCESS_texecarglist self) {
   ValueCast(P3PROCESS_texecarglist, SYSTEM_tobject_DOT_create(ValueCast(SYSTEM_tobject, self)));
   self->P3PROCESS_texecarglist_DOT_finheritedhandles = SYSTEM_true;
   return self;
}  /* create */

Destructor(P3PROCESS_texecarglist) P3PROCESS_texecarglist_DOT_destroy(P3PROCESS_texecarglist self) {
   P3PROCESS_texecarglist_DOT_clear(self);
   SYSTEM_tobject_DOT_destroy(ValueCast(SYSTEM_tobject, self));
   return self;
}  /* destroy */

Function(SYSTEM_ansichar *) P3PROCESS_texecarglist_DOT_getlast(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, P3PROCESS_texecarglist self) {
   if (self->P3PROCESS_texecarglist_DOT_fcount <= 0) {
      _P3strclr(result);
   }
   else
      P3PROCESS_getstring(result, _len_ret,
            ValueCast(SYSTEM_P3_pshortstring, (*self->P3PROCESS_texecarglist_DOT_flist)[self->P3PROCESS_texecarglist_DOT_fcount - 1]));
   return result;
}  /* getlast */

Procedure P3PROCESS_texecarglist_DOT_clear(P3PROCESS_texecarglist self) {
   SYSTEM_integer n;

   for (n = self->P3PROCESS_texecarglist_DOT_fcount - 1; n >= (SYSTEM_int32) 0; --n) {
...
Procedure P3PROCESS_texecarglist_DOT_delete(P3PROCESS_texecarglist self, SYSTEM_integer index) {
   ...
   if (index < self->P3PROCESS_texecarglist_DOT_fcount)
      SYSTEM_move(&(*self->P3PROCESS_texecarglist_DOT_flist)[index + 1], &(*self->P3PROCESS_texecarglist_DOT_flist)[index],
            (self->P3PROCESS_texecarglist_DOT_fcount - index) * sizeof(SYSTEM_pointer));
}  /* delete */

Procedure P3PROCESS_texecarglist_DOT_grow(P3PROCESS_texecarglist self) {
   ...
   else if (self->P3PROCESS_texecarglist_DOT_fcapacity == 0) {
      delta = 16;
   }
   else
      delta = 7 * self->P3PROCESS_texecarglist_DOT_fcapacity;
   P3PROCESS_texecarglist_DOT_setcapacity(self, self->P3PROCESS_texecarglist_DOT_fcapacity + delta);
}  /* grow */

Procedure P3PROCESS_texecarglist_DOT_setcapacity(P3PROCESS_texecarglist self, SYSTEM_integer newcapacity) {
   if (newcapacity != self->P3PROCESS_texecarglist_DOT_fcapacity) {
      ...
      SYSTEM_reallocmem(&PointerCast(SYSTEM_pointer, &self->P3PROCESS_texecarglist_DOT_flist), newcapacity * sizeof(SYSTEM_pointer));
      self->P3PROCESS_texecarglist_DOT_fcapacity = newcapacity;
   }
}  /* setcapacity */

Function(SYSTEM_integer) P3PROCESS_texecarglist_DOT_splitappend(P3PROCESS_texecarglist self, const SYSTEM_ansichar* s) {
   SYSTEM_integer result;
...
Function(SYSTEM_integer) P3PROCESS_texecarglist_DOT_splitprepend(P3PROCESS_texecarglist self, const SYSTEM_ansichar* s) {
   SYSTEM_integer result;
...
Function(SYSTEM_integer) P3PROCESS_texecarglist_DOT_split(P3PROCESS_texecarglist self, SYSTEM_integer append, const SYSTEM_ansichar* s) {
   SYSTEM_integer result;
...
Function(SYSTEM_integer) P3PROCESS_texecarglist_DOT_add(P3PROCESS_texecarglist self, const SYSTEM_ansichar* item) {
   SYSTEM_integer result;
   ...
   (*self->P3PROCESS_texecarglist_DOT_flist)[result] = P3PROCESS_newstring(item);
   _P3inc0(self->P3PROCESS_texecarglist_DOT_fcount);
   return result;
}  /* add */

Procedure P3PROCESS_texecarglist_DOT_freeitem(P3PROCESS_texecarglist self, SYSTEM_integer index) {
   P3PROCESS_disposestring(ValueCast(SYSTEM_P3_pshortstring, (*self->P3PROCESS_texecarglist_DOT_flist)[index]));
}  /* freeitem */

Function(SYSTEM_ansichar *) P3PROCESS_texecarglist_DOT_get(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, P3PROCESS_texecarglist self,
      SYSTEM_integer index) {
   P3PROCESS_getstring(result, _len_ret, ValueCast(SYSTEM_P3_pshortstring, (*self->P3PROCESS_texecarglist_DOT_flist)[index]));
   return result;
}  /* get */

Procedure P3PROCESS_texecarglist_DOT_insert(P3PROCESS_texecarglist self, SYSTEM_integer index, const SYSTEM_ansichar* item) {
   if (self->P3PROCESS_texecarglist_DOT_fcount == self->P3PROCESS_texecarglist_DOT_fcapacity)
      P3PROCESS_texecarglist_DOT_grow(self);
   if (index < self->P3PROCESS_texecarglist_DOT_fcount)
      SYSTEM_move(&(*self->P3PROCESS_texecarglist_DOT_flist)[index], &(*self->P3PROCESS_texecarglist_DOT_flist)[index + 1],
            (self->P3PROCESS_texecarglist_DOT_fcount - index) * sizeof(SYSTEM_pointer));
   (*self->P3PROCESS_texecarglist_DOT_flist)[index] = P3PROCESS_newstring(item);
   _P3inc0(self->P3PROCESS_texecarglist_DOT_fcount);
}  /* insert */

Procedure P3PROCESS_texecarglist_DOT_put(P3PROCESS_texecarglist self, SYSTEM_integer index, const SYSTEM_ansichar* _ftmp1) {
...
Procedure P3PROCESS_p3setshowwindow(SYSTEM_integer showwindow) {
...
Function(SYSTEM_boolean) P3PROCESS_p3getprocinfo(SYSTEM_integer* nphysical, SYSTEM_integer* nlogical) {
   SYSTEM_boolean result;
