...
Function(SYSTEM_P3_pansichar) PCHUTIL_strtopchar(const SYSTEM_ansichar* s) {
...
Function(SYSTEM_ansichar *) PCHUTIL_pchartostr(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, SYSTEM_P3_pansichar p) {
   SYSTEM_integer k;
...
Procedure PCHUTIL_convertpchar(SYSTEM_P3_pansichar p, SYSTEM_ansichar* s) {
   SYSTEM_integer k;
...
Function(SYSTEM_integer) PCHUTIL_pcharlen(SYSTEM_P3_pansichar p) {
...
Procedure PCHUTIL_pcharconcatpchar(SYSTEM_P3_pansichar pdest, SYSTEM_integer* w, SYSTEM_P3_pansichar psrc) {
   SYSTEM_integer k;

   if (psrc != NULL) {
      k = 0;
      while ((*ValueCast(GMSGEN_pansichararray, psrc))[k] != _P3char('\000')) {
         (*ValueCast(GMSGEN_pansichararray, pdest))[*w] = (*ValueCast(GMSGEN_pansichararray, psrc))[k];
         _P3inc0(*w);
         _P3inc0(k);
      }
...
Procedure PCHUTIL_pcharconcatstr(SYSTEM_P3_pansichar pdest, SYSTEM_integer* w, const SYSTEM_ansichar* src) {
   SYSTEM_integer k;
...
Procedure PCHUTIL_strpcopyn(SYSTEM_P3_pansichar pdest, const SYSTEM_ansichar* src, SYSTEM_integer n) {
   SYSTEM_integer k;
   SYSTEM_integer w;
   SYSTEM_integer m;
...
Function(SYSTEM_P3_pansichar) PCHUTIL_strtostrbuf(const SYSTEM_ansichar* src, SYSTEM_ansichar* dest) {
   SYSTEM_P3_pansichar result;
   SYSTEM_integer len;
