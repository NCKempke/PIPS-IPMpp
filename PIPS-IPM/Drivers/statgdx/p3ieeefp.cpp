...
_arr_0P3IEEEFP P3IEEEFP_fpclasstext = {{13, 's', 'i', 'g', 'n', 'a', 'l', 'i', 'n', 'g', ' ', 'N', 'a', 'N'},
                                       {9,  'q', 'u', 'i', 'e', 't', ' ', 'N', 'a', 'N'},
                                       {17, 'n', 'e', 'g', 'a', 't', 'i', 'v', 'e', ' ', 'i', 'n', 'f', 'i', 'n', 'i', 't', 'y'},
                                       {17, 'p', 'o', 's', 'i', 't', 'i', 'v', 'e', ' ', 'i', 'n', 'f', 'i', 'n', 'i', 't', 'y'},
                                       {30, 'n', 'e', 'g', 'a', 't', 'i', 'v', 'e', ' ', 'd', 'e', 'n', 'o', 'r', 'm', 'a', 'l', 'i', 'z', 'e', 'd', ' ', 'n', 'o', 'n', '-', 'z', 'e', 'r', 'o'},
                                       {30, 'p', 'o', 's', 'i', 't', 'i', 'v', 'e', ' ', 'd', 'e', 'n', 'o', 'r', 'm', 'a', 'l', 'i', 'z', 'e', 'd', ' ', 'n', 'o', 'n', '-', 'z', 'e', 'r', 'o'},
                                       {4,  '-', '0', '.', '0'},
                                       {4,  '+', '0', '.', '0'},
                                       {28, 'n', 'e', 'g', 'a', 't', 'i', 'v', 'e', ' ', 'n', 'o', 'r', 'm', 'a', 'l', 'i', 'z', 'e', 'd', ' ', 'n', 'o', 'n', '-', 'z', 'e', 'r', 'o'},
                                       {28, 'p', 'o', 's', 'i', 't', 'i', 'v', 'e', ' ', 'n', 'o', 'r', 'm', 'a', 'l', 'i', 'z', 'e', 'd', ' ', 'n', 'o', 'n', '-', 'z', 'e', 'r', 'o'}};
...
static Procedure P3IEEEFP_double2i64(SYSTEM_double x, SYSTEM_int64* i) {
...
Function(P3IEEEFP_tfpclass) P3IEEEFP_fpclass(SYSTEM_double x) {
...
Function(SYSTEM_boolean) P3IEEEFP_p3isfinite(SYSTEM_double x) {
   SYSTEM_boolean result;
   P3IEEEFP_ti64rec i64rec;

   i64rec._u._c1.x = x;
   result = ValueCast(SYSTEM_uint64, i64rec._u._c2.i64 & P3IEEEFP_expomask) >> 52 != 2047;
   return result;
}  /* p3isfinite */
...
void _Init_Module_p3ieeefp(void) {
   ...
   P3IEEEFP_i64rec._u._c2.i64 = ValueCast(SYSTEM_uint64, P3IEEEFP_i64rec._u._c2.i64) << 32;
