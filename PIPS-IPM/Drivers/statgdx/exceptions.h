...
typedef struct EXCEPTIONS_eabstracterror_OD_S* EXCEPTIONS_eabstracterror; /* sy_class */
...
typedef struct EXCEPTIONS_eaccessviolation_OD_S* EXCEPTIONS_eaccessviolation; /* sy_class */
...
typedef struct EXCEPTIONS_einvalidargument_OD_S* EXCEPTIONS_einvalidargument; /* sy_class */
...
typedef struct EXCEPTIONS_estackoverflow_OD_S* EXCEPTIONS_estackoverflow; /* sy_class */
...
typedef struct EXCEPTIONS_eassertionfailed_OD_S* EXCEPTIONS_eassertionfailed; /* sy_class */
...
typedef struct EXCEPTIONS_eexternalexception_OD_S* EXCEPTIONS_eexternalexception; /* sy_class */
...
typedef struct EXCEPTIONS_eheapexception_OD_S* EXCEPTIONS_eheapexception; /* sy_class */
...
typedef struct EXCEPTIONS_einvalidpointer_OD_S* EXCEPTIONS_einvalidpointer; /* sy_class */
...
typedef struct EXCEPTIONS_eintfcasterror_OD_S* EXCEPTIONS_eintfcasterror; /* sy_class */
...
typedef struct EXCEPTIONS_esafecallexception_OD_S* EXCEPTIONS_esafecallexception; /* sy_class */
...
typedef struct EXCEPTIONS_epropertyconverterror_OD_S* EXCEPTIONS_epropertyconverterror; /* sy_class */
...
typedef struct EXCEPTIONS_epropertyerror_OD_S* EXCEPTIONS_epropertyerror; /* sy_class */
...
/* Anonymous */
enum {
   EXCEPTIONS_cnoexception,
   EXCEPTIONS_cexception,
   EXCEPTIONS_cexternal,
   EXCEPTIONS_caccessviolation,
   EXCEPTIONS_cabort,
   EXCEPTIONS_cmatherror,
   EXCEPTIONS_ccontrolc,
   EXCEPTIONS_cinouterror,
   EXCEPTIONS_cconverterror,
   EXCEPTIONS_cinvalidcast,
   EXCEPTIONS_cinterror,
   EXCEPTIONS_crangeerror,
   EXCEPTIONS_cassertionfailed,
   EXCEPTIONS_cheapexception,
   EXCEPTIONS_coutofmemory,
   EXCEPTIONS_cabstracterror
};

Function(SYSTEM_tobject )
EXCEPTIONS_create_exception_by_code(
      EXCEPTIONS_texceptions
code,
...
extern void _P3_Std_Exception_Handler(SYSTEM_tobject
obj);
