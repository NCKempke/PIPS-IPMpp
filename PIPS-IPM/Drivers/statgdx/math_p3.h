...
MATH_P3_lnxp1(
      SYSTEM_double
x);
typedef SYSTEM_byte MATH_P3_tfpuexception; /* Anonymous */ enum {
   MATH_P3_exinvalidop, MATH_P3_exdenormalized, MATH_P3_exzerodivide, MATH_P3_exoverflow, MATH_P3_exunderflow, MATH_P3_exprecision
};
typedef _P3SET_7 MATH_P3_tfpuexceptionmask;

Function(_P3set_elem
*)
MATH_P3_getexceptionmask(
      _P3set_elem
*result,
