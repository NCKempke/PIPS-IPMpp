...
#endif
cnstdef {
SYSUTILS_P3_fareadonly = 1
};
cnstdef {
SYSUTILS_P3_fahidden = 2
};
cnstdef {
SYSUTILS_P3_fasysfile = 4
};
cnstdef {
SYSUTILS_P3_favolumeid = 8
};
cnstdef {
SYSUTILS_P3_fadirectory = 16
};
cnstdef {
SYSUTILS_P3_faarchive = 32
};
cnstdef {
SYSUTILS_P3_fasymlink = 64
};
cnstdef {
SYSUTILS_P3_faanyfile = 63
};
cnstdef {
SYSUTILS_P3_hoursperday = 24
};
cnstdef {
SYSUTILS_P3_minsperhour = 60
};
cnstdef {
SYSUTILS_P3_secspermin = 60
};
cnstdef {
SYSUTILS_P3_msecspersec = 1000
};
cnstdef {
SYSUTILS_P3_minsperday = 1440
};
cnstdef {
SYSUTILS_P3_secsperday = 86400
};
cnstdef {
SYSUTILS_P3_msecsperday = 86400000
};
cnstdef {
SYSUTILS_P3_datedelta = 693594
};
cnstdef {
SYSUTILS_P3_unixdatedelta = 25569
};
cnstdef {
SYSUTILS_P3_max_path = 260
};
...
Prototype Procedure(*SYSUTILS_P3_tprocedure)
(void);
...
extern SYSTEM_ansichar SYSUTILS_P3_pathdelim, SYSUTILS_P3_drivedelim, SYSUTILS_P3_pathsep;

Function(SYSTEM_pointer )
SYSUTILS_P3_allocmem(
      SYSTEM_cardinal
sz);

Function(SYSTEM_ansichar
*)
SYSUTILS_P3_uppercase(
      SYSTEM_ansichar
*result,
...
SYSUTILS_P3_comparestr(const SYSTEM_ansichar* s1, const SYSTEM_ansichar* s2);

Function(SYSTEM_integer )
SYSUTILS_P3_comparetext(const SYSTEM_ansichar* s1, const SYSTEM_ansichar* s2);

Function(SYSTEM_boolean )
SYSUTILS_P3_sametext(const SYSTEM_ansichar* s1, const SYSTEM_ansichar* s2);
...
Function(SYSTEM_ansichar
*)
SYSUTILS_P3_inttostr(
      SYSTEM_ansichar
*result,
SYSTEM_uint8 _len_ret, SYSTEM_int64
n);

Function(SYSTEM_ansichar
*)
SYSUTILS_P3_inttohex(
      SYSTEM_ansichar
*result,
SYSTEM_uint8 _len_ret, SYSTEM_int64
v,
...
Function(SYSTEM_integer )
SYSUTILS_P3_strtoint(const SYSTEM_ansichar* s);

Function(SYSTEM_int64 )
SYSUTILS_P3_strtoint64(const SYSTEM_ansichar* s);

Function(SYSTEM_integer )
SYSUTILS_P3_fileage(const SYSTEM_ansichar* filename);

Function(SYSTEM_boolean )
SYSUTILS_P3_fileexists(const SYSTEM_ansichar* filename);

Function(SYSTEM_boolean )
SYSUTILS_P3_directoryexists(const SYSTEM_ansichar* directory);

Function(SYSTEM_integer )
SYSUTILS_P3_findfirst(const SYSTEM_ansichar* path, SYSTEM_integer attr, SYSUTILS_P3_tsearchrec* f);

Function(SYSTEM_integer )
SYSUTILS_P3_findnext(
      SYSUTILS_P3_tsearchrec
*f);
...
Function(SYSTEM_boolean )
SYSUTILS_P3_deletefile(const SYSTEM_ansichar* filename);

Function(SYSTEM_boolean )
SYSUTILS_P3_renamefile(const SYSTEM_ansichar* oldname, const SYSTEM_ansichar* newname);

Function(SYSTEM_ansichar
*)
SYSUTILS_P3_changefileext(
      SYSTEM_ansichar
*result,
SYSTEM_uint8 _len_ret,
...
Function(SYSTEM_ansichar
*)
SYSUTILS_P3_extractshortpathname(
      SYSTEM_ansichar
*result,
SYSTEM_uint8 _len_ret,
const SYSTEM_ansichar* filename
...
Function(SYSTEM_P3_tdatetime )
SYSUTILS_P3_filedatetodatetime(
      SYSTEM_integer
filedate);

Function(SYSTEM_integer )
SYSUTILS_P3_datetimetofiledate(
      SYSTEM_P3_tdatetime
datetime);

Function(SYSTEM_ansichar
*)
SYSUTILS_P3_getcurrentdir(
      SYSTEM_ansichar
*result,
SYSTEM_uint8 _len_ret
);
...
Function(SYSTEM_boolean )
SYSUTILS_P3_setcurrentdir(const SYSTEM_ansichar* dir);

Function(SYSTEM_boolean )
SYSUTILS_P3_createdir(const SYSTEM_ansichar* dir);

Function(SYSTEM_boolean )
SYSUTILS_P3_removedir(const SYSTEM_ansichar* dir);
...
Function(SYSTEM_P3_pansichar )
SYSUTILS_P3_strpcopy(
      SYSTEM_P3_pansichar
dest,
...
Function(SYSTEM_ansichar
*)
SYSUTILS_P3_floattostr(
      SYSTEM_ansichar
*result,
SYSTEM_uint8 _len_ret, SYSTEM_double
v);

Function(SYSUTILS_P3_ttimestamp
*)
SYSUTILS_P3_datetimetotimestamp(
      SYSUTILS_P3_ttimestamp
*result,
...
Function(SYSTEM_P3_tdatetime )
SYSUTILS_P3_timestamptodatetime(const SYSUTILS_P3_ttimestamp* timestamp);

Function(SYSTEM_P3_tdatetime )
SYSUTILS_P3_encodedate(
      SYSTEM_word
year,
...
Function(SYSTEM_boolean )
SYSUTILS_P3_tryencodetime(
      SYSTEM_word
hour,
SYSTEM_word _min, SYSTEM_word
sec,
SYSTEM_word msec, SYSTEM_P3_tdatetime
*time);

Procedure SYSUTILS_P3_decodedate(SYSTEM_P3_tdatetime
datetime,
...
Procedure SYSUTILS_P3_decodetime(SYSTEM_P3_tdatetime
datetime,
SYSTEM_word* hour, SYSTEM_word
*_min,
SYSTEM_word* sec, SYSTEM_word
*msec);

Function(SYSTEM_P3_tdatetime )
SYSUTILS_P3_date(void);

Function(SYSTEM_P3_tdatetime )
SYSUTILS_P3_time(void);

Function(SYSTEM_P3_tdatetime )
SYSUTILS_P3_now(void);

Function(SYSTEM_boolean )
SYSUTILS_P3_isleapyear(
      SYSTEM_word
year);
...
Function(SYSTEM_ansichar
*)
SYSUTILS_P3_syserrormessage(
      SYSTEM_ansichar
*result,
SYSTEM_uint8 _len_ret, SYSTEM_integer
errorcode);

Procedure SYSUTILS_P3_sleep(SYSTEM_cardinal
milliseconds);

Function(SYSTEM_ansichar
*)
SYSUTILS_P3_includetrailingpathdelimiter(
      SYSTEM_ansichar
*result,
SYSTEM_uint8 _len_ret,
const SYSTEM_ansichar* s
...
Function(SYSTEM_ansichar
*)
SYSUTILS_P3_excludetrailingpathdelimiter(
      SYSTEM_ansichar
*result,
SYSTEM_uint8 _len_ret,
const SYSTEM_ansichar* s
...
Function(SYSTEM_integer )
SYSUTILS_P3_lastdelimiter(const SYSTEM_ansichar* delimiters, const SYSTEM_ansichar* s);

Procedure SYSUTILS_P3_freeandnil(SYSTEM_untyped* obj);

Function(SYSTEM_ansichar
*)
SYSUTILS_P3_getenvironmentvariable(
      SYSTEM_ansichar
*result,
SYSTEM_uint8 _len_ret,
