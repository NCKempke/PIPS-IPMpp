...
_arr_0GMSGLOB GMSGLOB_ssymboltext = {{2,  'e', 'q'},
                                     {2,  'g', 't'},
                                     {2,  'g', 'e'},
                                     {2,  'l', 't'},
                                     {2,  'l', 'e'},
                                     ...
                                     {6,  'u', 'n', 'l', 'o', 'a', 'd'},
                                     {9,  'l', 'o', 'a', 'd', 'p', 'o', 'i', 'n', 't'},
                                     {10, 'l', 'o', 'a', 'd', 'h', 'a', 'n', 'd', 'l', 'e'},
                                     {6,  'l', 'o', 'a', 'd', 'd', 'c'},
                                     {8,  'u', 'n', 'l', 'o', 'a', 'd', 'd', 'i'},
                                     {9,  'u', 'n', 'l', 'o', 'a', 'd', 'i', 'd', 'x'},
                                     {5,  'b', 'r', 'e', 'a', 'k'},
                                     {8,  'c', 'o', 'n', 't', 'i', 'n', 'u', 'e'},
                                     {12, 'e', 'm', 'b', 'e', 'd', 'd', 'e', 'd', 'i', 'n', 'i', 't'},
                                     {12, 'e', 'm', 'b', 'e', 'd', 'd', 'e', 'd', 'f', 'r', 'e', 'e'},
                                     {3,  'p', 'u', 't'},
                                     {3,  'p', 't', 'l'},
                                     {3,  'p', 'h', 'd'},
                                     {6,  'p', 'c', 'l', 'e', 'a', 'r'},
...
static Procedure GMSGLOB_initdefaultrecords(void) {
   ...
   if ((v = GMSSPECS_stypunknwn) <= (GMSSPECS_stypsemiint))
      do {
   ...
   GMSGLOB_defrecvar[GMSSPECS_stypint][GMSSPECS_valupper] = GMSSPECS_valiup;
   GMSGLOB_defrecvar[GMSSPECS_styppos][GMSSPECS_valupper] = GMSSPECS_valpin;
   GMSGLOB_defrecvar[GMSSPECS_stypneg][GMSSPECS_vallower] = GMSSPECS_valmin;
   GMSGLOB_defrecvar[GMSSPECS_stypfre][GMSSPECS_vallower] = GMSSPECS_valmin;
   GMSGLOB_defrecvar[GMSSPECS_stypfre][GMSSPECS_valupper] = GMSSPECS_valpin;
   GMSGLOB_defrecvar[GMSSPECS_stypsos1][GMSSPECS_valupper] = GMSSPECS_valpin;
   GMSGLOB_defrecvar[GMSSPECS_stypsos2][GMSSPECS_valupper] = GMSSPECS_valpin;
   GMSGLOB_defrecvar[GMSSPECS_stypsemi][GMSSPECS_vallower] = 1.0;
   GMSGLOB_defrecvar[GMSSPECS_stypsemi][GMSSPECS_valupper] = GMSSPECS_valpin;
   GMSGLOB_defrecvar[GMSSPECS_stypsemiint][GMSSPECS_vallower] = 1.0;
   GMSGLOB_defrecvar[GMSSPECS_stypsemiint][GMSSPECS_valupper] = GMSSPECS_valiup;
...
void _Init_Module_gmsglob(void) {
   for (GMSGLOB_e = GMSGLOB_ssyeque; GMSGLOB_e <= GMSGLOB_ssyequb; ++GMSGLOB_e) {
      GMSSPECS_equstypinfo[ValueCast(GMSSPECS_tequstyp, SYSTEM_ord(GMSGLOB_e) - 53)] = SYSTEM_ord(GMSGLOB_e);
   }
