...
Procedure P3PRIVATE_pcharconcatpchar(SYSTEM_P3_pansichar pdest, SYSTEM_integer* w, SYSTEM_P3_pansichar psrc) {
   SYSTEM_integer len;
...
Procedure P3PRIVATE_pcharconcatstr(SYSTEM_P3_pansichar pdest, SYSTEM_integer* w, const SYSTEM_ansichar* src) {
   SYSTEM_integer len;
...
Function(SYSTEM_P3_pansichar) P3PRIVATE_strtopchar(const SYSTEM_ansichar* src) {
...
Function(SYSTEM_P3_pansichar) P3PRIVATE_strtostrbuf(const SYSTEM_ansichar* src, SYSTEM_ansichar* dest) {
   SYSTEM_P3_pansichar result;
   SYSTEM_integer len;
...
Function(SYSTEM_ansichar *) P3PRIVATE_strbuftostr(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* src) {
...
Function(SYSTEM_ansichar *) P3PRIVATE_pchartostr(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, SYSTEM_P3_pansichar psrc) {
   SYSTEM_integer len, i;
