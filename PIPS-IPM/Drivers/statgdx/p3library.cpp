...
Function(P3LIBRARY_tlibhandle) P3LIBRARY_p3loadlibrary(const SYSTEM_ansichar* lib, SYSTEM_ansichar* loadmsg) {
...
Function(SYSTEM_pointer) P3LIBRARY_p3getprocaddress(P3LIBRARY_tlibhandle handle, const SYSTEM_ansichar* name) {
...
Function(SYSTEM_boolean) P3LIBRARY_p3freelibrary(P3LIBRARY_tlibhandle handle) {
...
Function(SYSTEM_boolean) P3LIBRARY_p3libhandleisnil(P3LIBRARY_tlibhandle handle) {
   SYSTEM_boolean result;
...
Function(SYSTEM_ansichar *) P3LIBRARY_p3makelibname(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* path,
   ...
   if (_P3strcmpE(path, _P3str1("\000"))) {
      {
         ...
         _P3strcat(result, _len_ret, _P3strcat(_t2, 255, P3LIBRARY_p3libraryprefix(_t1, 255), base), P3LIBRARY_p3libraryext(_t3, 255));
      }
   }
   else {
      SYSTEM_shortstring _t1;
      ...
      _P3strcat(result, _len_ret, _P3strcat(_t6, 255, _P3strcat(_t5, 255,
            _P3strcat(_t3, 255, VariableCast(SYSTEM_shortstring, SYSUTILS_P3_excludetrailingpathdelimiter(_t1, 255, path), SYSTEM_shortstring),
                  _P3ch2str(_t2, 1, SYSUTILS_P3_pathdelim)), P3LIBRARY_p3libraryprefix(_t4, 255)), base), P3LIBRARY_p3libraryext(_t7, 255));
   }
   return result;
}  /* p3makelibname */
...
Function(SYSTEM_ansichar *) P3LIBRARY_p3libraryext(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret) {
   _P3strcpy(result, _len_ret, P3PLATFORM_osdllextension[P3PLATFORM_osplatform()]);
   return result;
}  /* p3libraryext */

Function(SYSTEM_ansichar *) P3LIBRARY_p3libraryprefix(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret) {
   _P3strcpy(result, _len_ret, P3PLATFORM_osdllprefix[P3PLATFORM_osplatform()]);
   return result;
}  /* p3libraryprefix */
