...
Function(SYSTEM_ansichar *) GMSLIBNAME_gamslibnameold(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* s) {
...
Function(SYSTEM_ansichar *) GMSLIBNAME_gamslibnamep3(SYSTEM_ansichar* result, SYSTEM_uint8 _len_ret, const SYSTEM_ansichar* s) {
